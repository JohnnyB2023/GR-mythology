...
public class b4xtimedtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new anywheresoftware.b4a.ShellBA(_ba, this, htSubs, "gr.mythologia.b4xtimedtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", gr.mythologia.b4xtimedtemplate.class).invoke(this, new Object[] {null});
        else
...
public gr.mythologia.anotherprogressbar _anotherprogressbar1 = null;
...
public anywheresoftware.b4a.objects.B4XViewWrapper  _getpanel(gr.mythologia.b4xtimedtemplate __ref,gr.mythologia.b4xdialog _dialog) throws Exception{
__ref = this;
...
public void  _show(gr.mythologia.b4xtimedtemplate __ref,gr.mythologia.b4xdialog _dialog) throws Exception{
RDebugUtils.currentModule="b4xtimedtemplate";
...
public ResumableSub_Show(gr.mythologia.b4xtimedtemplate parent,gr.mythologia.b4xtimedtemplate __ref,gr.mythologia.b4xdialog _dialog) {
this.parent = parent;
this.__ref = __ref;
this._dialog = _dialog;
this.__ref = parent;
}
gr.mythologia.b4xtimedtemplate __ref;
gr.mythologia.b4xtimedtemplate parent;
...
__ref._anotherprogressbar1 /*gr.mythologia.anotherprogressbar*/ ._setvaluenoanimation /*String*/ (null,(int) (0));
RDebugUtils.currentLine=19660803;
 //BA.debugLineNum = 19660803;BA.debugLine="AnotherProgressBar1.ValueChangePerSecond = 100 /";
__ref._anotherprogressbar1 /*gr.mythologia.anotherprogressbar*/ ._valuechangepersecond /*float*/  = (float) (100/(double)(__ref._timeoutmilliseconds /*int*/ /(double)1000));
RDebugUtils.currentLine=19660804;
 //BA.debugLineNum = 19660804;BA.debugLine="AnotherProgressBar1.Value = 100";
__ref._anotherprogressbar1 /*gr.mythologia.anotherprogressbar*/ ._setvalue /*int*/ (null,(int) (100));
...
public String  _dialogclosed(gr.mythologia.b4xtimedtemplate __ref,int _result) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xtimedtemplate";
...
public String  _class_globals(gr.mythologia.b4xtimedtemplate __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xtimedtemplate";
...
_anotherprogressbar1 = new gr.mythologia.anotherprogressbar();
...
public String  _initialize(gr.mythologia.b4xtimedtemplate __ref,anywheresoftware.b4a.BA _ba,Object _innertemplate) throws Exception{
__ref = this;
innerInitialize(_ba);
RDebugUtils.currentModule="b4xtimedtemplate";
