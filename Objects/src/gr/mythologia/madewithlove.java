...
public class madewithlove extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new anywheresoftware.b4a.ShellBA(_ba, this, htSubs, "gr.mythologia.madewithlove");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", gr.mythologia.madewithlove.class).invoke(this, new Object[] {null});
        else
...
public String  _base_resize(gr.mythologia.madewithlove __ref,double _width,double _height) throws Exception{
__ref = this;
...
public String  _class_globals(gr.mythologia.madewithlove __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="madewithlove";
...
public String  _designercreateview(gr.mythologia.madewithlove __ref,Object _base,anywheresoftware.b4a.objects.LabelWrapper _lbl,anywheresoftware.b4a.objects.collections.Map _props) throws Exception{
__ref = this;
RDebugUtils.currentModule="madewithlove";
...
public String  _initialize(gr.mythologia.madewithlove __ref,anywheresoftware.b4a.BA _ba,Object _callback,String _eventname) throws Exception{
__ref = this;
innerInitialize(_ba);
RDebugUtils.currentModule="madewithlove";
