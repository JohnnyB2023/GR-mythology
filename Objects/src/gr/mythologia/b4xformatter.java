...
public class b4xformatter extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new anywheresoftware.b4a.ShellBA(_ba, this, htSubs, "gr.mythologia.b4xformatter");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", gr.mythologia.b4xformatter.class).invoke(this, new Object[] {null});
        else
...
public gr.mythologia.b4xformatter._b4xformatdata  _getdefaultformat(gr.mythologia.b4xformatter __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xformatter";
if (Debug.shouldDelegate(ba, "getdefaultformat", true))
	 {return ((gr.mythologia.b4xformatter._b4xformatdata) Debug.delegate(ba, "getdefaultformat", null));}
...
if (true) return (gr.mythologia.b4xformatter._b4xformatdata)(__ref._formats /*anywheresoftware.b4a.objects.collections.List*/ .Get((int) (0)));
RDebugUtils.currentLine=20447234;
 //BA.debugLineNum = 20447234;BA.debugLine="End Sub";
return null;
}
public String  _format(gr.mythologia.b4xformatter __ref,double _number) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xformatter";
if (Debug.shouldDelegate(ba, "format", true))
	 {return ((String) Debug.delegate(ba, "format", new Object[] {_number}));}
gr.mythologia.b4xformatter._b4xformatdata _data = null;
...
_data = __ref._getformatdata /*gr.mythologia.b4xformatter._b4xformatdata*/ (null,_number);
...
public String  _initialize(gr.mythologia.b4xformatter __ref,anywheresoftware.b4a.BA _ba) throws Exception{
__ref = this;
innerInitialize(_ba);
RDebugUtils.currentModule="b4xformatter";
if (Debug.shouldDelegate(ba, "initialize", true))
	 {return ((String) Debug.delegate(ba, "initialize", new Object[] {_ba}));}
gr.mythologia.b4xformatter._b4xformatdata _d = null;
...
_d = __ref._createdefaultformat /*gr.mythologia.b4xformatter._b4xformatdata*/ (null);
...
public String  _addformatdata(gr.mythologia.b4xformatter __ref,gr.mythologia.b4xformatter._b4xformatdata _data,double _rangestart,double _rangeend,boolean _includeedges) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xformatter";
...
public String  _class_globals(gr.mythologia.b4xformatter __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xformatter";
...
RDebugUtils.currentLine=20054024;
 //BA.debugLineNum = 20054024;BA.debugLine="Private xui As XUI";
_xui = new anywheresoftware.b4a.objects.B4XViewWrapper.XUI();
RDebugUtils.currentLine=20054026;
 //BA.debugLineNum = 20054026;BA.debugLine="End Sub";
return "";
}
public gr.mythologia.b4xformatter._b4xformatdata  _copyformatdata(gr.mythologia.b4xformatter __ref,gr.mythologia.b4xformatter._b4xformatdata _data) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xformatter";
if (Debug.shouldDelegate(ba, "copyformatdata", true))
	 {return ((gr.mythologia.b4xformatter._b4xformatdata) Debug.delegate(ba, "copyformatdata", new Object[] {_data}));}
gr.mythologia.b4xformatter._b4xformatdata _d = null;
...
_d = new gr.mythologia.b4xformatter._b4xformatdata();
...
public gr.mythologia.b4xformatter._b4xformatdata  _createdefaultformat(gr.mythologia.b4xformatter __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xformatter";
if (Debug.shouldDelegate(ba, "createdefaultformat", true))
	 {return ((gr.mythologia.b4xformatter._b4xformatdata) Debug.delegate(ba, "createdefaultformat", null));}
gr.mythologia.b4xformatter._b4xformatdata _d = null;
...
public gr.mythologia.b4xformatter._b4xformatdata  _getformatdata(gr.mythologia.b4xformatter __ref,double _number) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xformatter";
if (Debug.shouldDelegate(ba, "getformatdata", true))
	 {return ((gr.mythologia.b4xformatter._b4xformatdata) Debug.delegate(ba, "getformatdata", new Object[] {_number}));}
int _i = 0;
gr.mythologia.b4xformatter._b4xformatdata _d = null;
...
_d = (gr.mythologia.b4xformatter._b4xformatdata)(__ref._formats /*anywheresoftware.b4a.objects.collections.List*/ .Get(_i));
...
public String  _formatlabel(gr.mythologia.b4xformatter __ref,double _number,anywheresoftware.b4a.objects.B4XViewWrapper _label) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xformatter";
...
public gr.mythologia.b4xformatter._b4xformatdata  _newformatdata(gr.mythologia.b4xformatter __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xformatter";
if (Debug.shouldDelegate(ba, "newformatdata", true))
	 {return ((gr.mythologia.b4xformatter._b4xformatdata) Debug.delegate(ba, "newformatdata", null));}
...
if (true) return __ref._copyformatdata /*gr.mythologia.b4xformatter._b4xformatdata*/ (null,__ref._getdefaultformat /*gr.mythologia.b4xformatter._b4xformatdata*/ (null));
