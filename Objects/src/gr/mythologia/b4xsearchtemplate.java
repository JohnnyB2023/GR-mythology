...
public class b4xsearchtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new anywheresoftware.b4a.ShellBA(_ba, this, htSubs, "gr.mythologia.b4xsearchtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", gr.mythologia.b4xsearchtemplate.class).invoke(this, new Object[] {null});
        else
...
public gr.mythologia.b4xfloattextfield _searchfield = null;
...
public anywheresoftware.b4a.objects.B4XViewWrapper  _getpanel(gr.mythologia.b4xsearchtemplate __ref,gr.mythologia.b4xdialog _dialog) throws Exception{
__ref = this;
...
public void  _show(gr.mythologia.b4xsearchtemplate __ref,gr.mythologia.b4xdialog _dialog) throws Exception{
RDebugUtils.currentModule="b4xsearchtemplate";
...
public ResumableSub_Show(gr.mythologia.b4xsearchtemplate parent,gr.mythologia.b4xsearchtemplate __ref,gr.mythologia.b4xdialog _dialog) {
this.parent = parent;
this.__ref = __ref;
this._dialog = _dialog;
this.__ref = parent;
}
gr.mythologia.b4xsearchtemplate __ref;
...
__ref._searchfield /*gr.mythologia.b4xfloattextfield*/ ._settext /*String*/ (null,"");
RDebugUtils.currentLine=16973834;
 //BA.debugLineNum = 16973834;BA.debugLine="SearchField.TextField.RequestFocus";
__ref._searchfield /*gr.mythologia.b4xfloattextfield*/ ._gettextfield /*anywheresoftware.b4a.objects.B4XViewWrapper*/ (null).RequestFocus();
RDebugUtils.currentLine=16973836;
 //BA.debugLineNum = 16973836;BA.debugLine="IME.ShowKeyboard(SearchField.TextField)";
__ref._ime /*anywheresoftware.b4a.objects.IME*/ .ShowKeyboard((android.view.View)(__ref._searchfield /*gr.mythologia.b4xfloattextfield*/ ._gettextfield /*anywheresoftware.b4a.objects.B4XViewWrapper*/ (null).getObject()));
...
public String  _dialogclosed(gr.mythologia.b4xsearchtemplate __ref,int _result) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xsearchtemplate";
...
public String  _additemstolist(gr.mythologia.b4xsearchtemplate __ref,anywheresoftware.b4a.objects.collections.List _li,String _full) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xsearchtemplate";
...
public String  _class_globals(gr.mythologia.b4xsearchtemplate __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xsearchtemplate";
...
_searchfield = new gr.mythologia.b4xfloattextfield();
...
public String  _customlistview1_itemclick(gr.mythologia.b4xsearchtemplate __ref,int _index,Object _value) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xsearchtemplate";
...
public String  _initialize(gr.mythologia.b4xsearchtemplate __ref,anywheresoftware.b4a.BA _ba) throws Exception{
__ref = this;
innerInitialize(_ba);
RDebugUtils.currentModule="b4xsearchtemplate";
...
_jo = (anywheresoftware.b4j.object.JavaObject) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4j.object.JavaObject(), (java.lang.Object)(__ref._searchfield /*gr.mythologia.b4xfloattextfield*/ ._gettextfield /*anywheresoftware.b4a.objects.B4XViewWrapper*/ (null).getObject()));
...
public String  _resize(gr.mythologia.b4xsearchtemplate __ref,int _width,int _height) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xsearchtemplate";
...
public String  _searchfield_enterpressed(gr.mythologia.b4xsearchtemplate __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xsearchtemplate";
...
public String  _searchfield_textchanged(gr.mythologia.b4xsearchtemplate __ref,String _old,String _new) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xsearchtemplate";
...
public String  _update(gr.mythologia.b4xsearchtemplate __ref,String _term,boolean _force) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xsearchtemplate";
...
public String  _setindex(gr.mythologia.b4xsearchtemplate __ref,Object _index) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xsearchtemplate";
...
public Object  _setitems(gr.mythologia.b4xsearchtemplate __ref,anywheresoftware.b4a.objects.collections.List _items) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xsearchtemplate";
