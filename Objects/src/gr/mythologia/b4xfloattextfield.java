...
public class b4xfloattextfield extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "gr.mythologia.b4xfloattextfield");
            if (htSubs == null) {
...
__c.LogImpl("98781848","Multiline not supported with password mode.",0);
 };
...
public gr.mythologia.b4xfloattextfield  _getnextfield() throws Exception{
...
_showacceptbuttonwhenempty = _xui.getIsB4i();
...
if (_mnexttextfield.IsInitialized /*boolean*/ ()==__c.False || (_mnexttextfield).equals((gr.mythologia.b4xfloattextfield)(this))) { 
...
_mtextfield.setEnabled(_b);
 //BA.debugLineNum = 409;BA.debugLine="UpdateLabel(mTextField.Text, False)";
_updatelabel(_mtextfield.getText(),__c.False);
 //BA.debugLineNum = 410;BA.debugLine="End Sub";
return "";
}
public String  _setnextfield(gr.mythologia.b4xfloattextfield _field) throws Exception{
...
_mnexttextfield = (gr.mythologia.b4xfloattextfield)(_o);
...
public ResumableSub_SwitchFromPasswordToRegular(gr.mythologia.b4xfloattextfield parent,boolean _toregular) {
this.parent = parent;
...
if (_mnexttextfield.IsInitialized /*boolean*/ () && (_mnexttextfield).equals((gr.mythologia.b4xfloattextfield)(this)) == false) { 
...
_lbl.setVisible(_focused && ((_showacceptbuttonwhenempty && (_lbl).equals(_lblv)) || _txt.length()>0) && _menabled);};
 }
};
