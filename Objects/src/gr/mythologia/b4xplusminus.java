...
public class b4xplusminus extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new anywheresoftware.b4a.ShellBA(_ba, this, htSubs, "gr.mythologia.b4xplusminus");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", gr.mythologia.b4xplusminus.class).invoke(this, new Object[] {null});
        else
...
public gr.mythologia.b4xformatter _formatter = null;
...
public String  _base_resize(gr.mythologia.b4xplusminus __ref,double _width,double _height) throws Exception{
__ref = this;
...
public String  _class_globals(gr.mythologia.b4xplusminus __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xplusminus";
...
_formatter = new gr.mythologia.b4xformatter();
...
public anywheresoftware.b4a.objects.B4XViewWrapper  _createlabel(gr.mythologia.b4xplusminus __ref,String _text) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xplusminus";
...
public String  _decrement(gr.mythologia.b4xplusminus __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xplusminus";
...
public String  _setindex(gr.mythologia.b4xplusminus __ref,int _i,boolean _raiseevent) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xplusminus";
...
__ref._mainlabel /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .setText(BA.ObjectToCharSequence(__ref._formatter /*gr.mythologia.b4xformatter*/ ._format /*String*/ (null,(double)(BA.ObjectToNumber(_value)))));
 };
...
public String  _designercreateview(gr.mythologia.b4xplusminus __ref,Object _base,anywheresoftware.b4a.objects.LabelWrapper _lbl,anywheresoftware.b4a.objects.collections.Map _props) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xplusminus";
...
__ref._formatter /*gr.mythologia.b4xformatter*/ ._getdefaultformat /*gr.mythologia.b4xformatter._b4xformatdata*/ (null).FormatFont /*anywheresoftware.b4a.objects.B4XViewWrapper.B4XFont*/  = __ref._mainlabel /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getFont();
RDebugUtils.currentLine=14286873;
 //BA.debugLineNum = 14286873;BA.debugLine="Formatter.GetDefaultFormat.TextColor = MainLabel.";
__ref._formatter /*gr.mythologia.b4xformatter*/ ._getdefaultformat /*gr.mythologia.b4xformatter._b4xformatdata*/ (null).TextColor /*int*/  = __ref._mainlabel /*anywheresoftware.b4a.objects.B4XViewWrapper*/ .getTextColor();
...
public Object  _getselectedvalue(gr.mythologia.b4xplusminus __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xplusminus";
...
public Object  _getvalueimpl(gr.mythologia.b4xplusminus __ref,int _index) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xplusminus";
...
public String  _increment(gr.mythologia.b4xplusminus __ref) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xplusminus";
...
if ((__ref._formatter /*gr.mythologia.b4xformatter*/ ._format /*String*/ (null,_v1)).equals(__ref._formatter /*gr.mythologia.b4xformatter*/ ._format /*String*/ (null,_v2))) { 
...
public String  _initialize(gr.mythologia.b4xplusminus __ref,anywheresoftware.b4a.BA _ba,Object _callback,String _eventname) throws Exception{
__ref = this;
innerInitialize(_ba);
RDebugUtils.currentModule="b4xplusminus";
...
__ref._formatter /*gr.mythologia.b4xformatter*/ ._initialize /*String*/ (null,ba);
RDebugUtils.currentLine=14221316;
 //BA.debugLineNum = 14221316;BA.debugLine="End Sub";
return "";
}
public String  _internalsettextorcsbuildertolabel(gr.mythologia.b4xplusminus __ref,anywheresoftware.b4a.objects.B4XViewWrapper _xlbl,Object _text) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xplusminus";
...
public String  _pnlarrow_touch(gr.mythologia.b4xplusminus __ref,int _action,float _x,float _y) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xplusminus";
...
public String  _touch(gr.mythologia.b4xplusminus __ref,boolean _start,boolean _stop,anywheresoftware.b4a.objects.B4XViewWrapper _pnl) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xplusminus";
...
public String  _setnumericrange(gr.mythologia.b4xplusminus __ref,double _startrange,double _endrange,double _interval) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xplusminus";
...
public String  _setselectedvalue(gr.mythologia.b4xplusminus __ref,Object _v) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xplusminus";
...
public String  _setstringitems(gr.mythologia.b4xplusminus __ref,anywheresoftware.b4a.objects.collections.List _list) throws Exception{
__ref = this;
RDebugUtils.currentModule="b4xplusminus";
...
public void  _startdownloop(gr.mythologia.b4xplusminus __ref,boolean _up) throws Exception{
RDebugUtils.currentModule="b4xplusminus";
...
public ResumableSub_StartDownLoop(gr.mythologia.b4xplusminus parent,gr.mythologia.b4xplusminus __ref,boolean _up) {
this.parent = parent;
this.__ref = __ref;
this._up = _up;
this.__ref = parent;
}
gr.mythologia.b4xplusminus __ref;
