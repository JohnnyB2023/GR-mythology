...
b4xprogressdialog._loadingindicator = RemoteObject.createNew ("gr.mythologia.b4xloadingindicator");__ref.setField("_loadingindicator",b4xprogressdialog._loadingindicator);
...
b4xprogressdialog._mdialog = RemoteObject.createNew ("gr.mythologia.b4xdialog");__ref.setField("_mdialog",b4xprogressdialog._mdialog);
 //BA.debugLineNum = 8;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _dialogclosed(RemoteObject __ref,RemoteObject _result) throws Exception{
try {
		Debug.PushSubsStack("DialogClosed (b4xprogressdialog) ","b4xprogressdialog",16,__ref.getField(false, "ba"),__ref,55);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_loadingindicator" /*RemoteObject*/ ).runClassMethod (gr.mythologia.b4xloadingindicator.class, "_hide" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("GetPanel (b4xprogressdialog) ","b4xprogressdialog",16,__ref.getField(false, "ba"),__ref,33);
...
try {
		Debug.PushSubsStack("getText (b4xprogressdialog) ","b4xprogressdialog",16,__ref.getField(false, "ba"),__ref,28);
...
try {
		Debug.PushSubsStack("Hide (b4xprogressdialog) ","b4xprogressdialog",16,__ref.getField(false, "ba"),__ref,47);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mdialog" /*RemoteObject*/ ).runClassMethod (gr.mythologia.b4xdialog.class, "_close" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, 0)));
...
try {
		Debug.PushSubsStack("Initialize (b4xprogressdialog) ","b4xprogressdialog",16,__ref.getField(false, "ba"),__ref,11);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mdialog" /*RemoteObject*/ ).runClassMethod (gr.mythologia.b4xdialog.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(_parent));
...
try {
		Debug.PushSubsStack("setText (b4xprogressdialog) ","b4xprogressdialog",16,__ref.getField(false, "ba"),__ref,24);
...
try {
		Debug.PushSubsStack("Show (b4xprogressdialog) ","b4xprogressdialog",16,__ref.getField(false, "ba"),__ref,51);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_loadingindicator" /*RemoteObject*/ ).runClassMethod (gr.mythologia.b4xloadingindicator.class, "_show" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("ShowDialog (b4xprogressdialog) ","b4xprogressdialog",16,__ref.getField(false, "ba"),__ref,39);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xprogressdialog.class, "_settext" /*RemoteObject*/ ,(Object)(_text));
 BA.debugLineNum = 41;BA.debugLine="If mDialog.Visible = False Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_mdialog" /*RemoteObject*/ ).runClassMethod (gr.mythologia.b4xdialog.class, "_getvisible" /*RemoteObject*/ ),b4xprogressdialog.__c.getField(true,"False"))) { 
 BA.debugLineNum = 42;BA.debugLine="mDialog.ShowTemplate(Me, \"\", \"\", \"\")";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mdialog" /*RemoteObject*/ ).runClassMethod (gr.mythologia.b4xdialog.class, "_showtemplate" /*RemoteObject*/ ,(Object)(__ref),(Object)(RemoteObject.createImmutable((""))),(Object)(RemoteObject.createImmutable((""))),(Object)((RemoteObject.createImmutable(""))));
 };
