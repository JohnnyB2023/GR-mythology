...
try {
		Debug.PushSubsStack("Base_Resize (swiftbutton) ","swiftbutton",27,__ref.getField(false, "ba"),__ref,54);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.swiftbutton.class, "_draw" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("DesignerCreateView (swiftbutton) ","swiftbutton",27,__ref.getField(false, "ba"),__ref,32);
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_disabledcolor" /*RemoteObject*/ ,__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"PaintOrColorToColor",(Object)(_props.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("DisabledColor"))),(Object)(RemoteObject.createImmutable((((int)0xff999999))))))));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setVisible",swiftbutton.__c.getField(true,"True"));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runVoidMethod ("AddView",(Object)((_p.getObject())),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.swiftbutton.class, "_base_resize" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"))));
...
try {
		Debug.PushSubsStack("Draw (swiftbutton) ","swiftbutton",27,__ref.getField(false, "ba"),__ref,121);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setTop",BA.numberCast(int.class, 0));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xlbl" /*RemoteObject*/ ).runMethod(true,"setTop",__ref.getField(true,"_sideheight" /*RemoteObject*/ ));
...
try {
		Debug.PushSubsStack("getEnabled (swiftbutton) ","swiftbutton",27,__ref.getField(false, "ba"),__ref,62);
...
try {
		Debug.PushSubsStack("Initialize (swiftbutton) ","swiftbutton",27,__ref.getField(false, "ba"),__ref,27);
...
try {
		Debug.PushSubsStack("p_Touch (swiftbutton) ","swiftbutton",27,__ref.getField(false, "ba"),__ref,72);
...
Debug.JustUpdateDeviceLine();
switch (BA.switchObjectToInt(_action,__ref.getField(false,"_mbase" /*RemoteObject*/ ).getField(true,"TOUCH_ACTION_DOWN"),__ref.getField(false,"_mbase" /*RemoteObject*/ ).getField(true,"TOUCH_ACTION_MOVE"),__ref.getField(false,"_mbase" /*RemoteObject*/ ).getField(true,"TOUCH_ACTION_UP"),BA.numberCast(int.class, 3))) {
case 0: {
 BA.debugLineNum = 77;BA.debugLine="SetPressedState(True)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.swiftbutton.class, "_setpressedstate" /*RemoteObject*/ ,(Object)(swiftbutton.__c.getField(true,"True")));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.swiftbutton.class, "_setpressedstate" /*RemoteObject*/ ,(Object)(_inside));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.swiftbutton.class, "_setpressedstate" /*RemoteObject*/ ,(Object)(swiftbutton.__c.getField(true,"False")));
...
swiftbutton._xuiviewsutils.runVoidMethod ("_performhapticfeedback" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ )));};
...
try {
		Debug.PushSubsStack("SetColors (swiftbutton) ","swiftbutton",27,__ref.getField(false, "ba"),__ref,111);
...
try {
		Debug.PushSubsStack("setEnabled (swiftbutton) ","swiftbutton",27,__ref.getField(false, "ba"),__ref,66);
...
try {
		Debug.PushSubsStack("SetPressedState (swiftbutton) ","swiftbutton",27,__ref.getField(false, "ba"),__ref,94);
...
try {
		Debug.PushSubsStack("Update (swiftbutton) ","swiftbutton",27,__ref.getField(false, "ba"),__ref,117);
