...
try {
		Debug.PushSubsStack("Base_Resize (scrollinglabel) ","scrollinglabel",26,__ref.getField(false, "ba"),__ref,40);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.scrollinglabel.class, "_settext" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_mtext" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("DesignerCreateView (scrollinglabel) ","scrollinglabel",26,__ref.getField(false, "ba"),__ref,23);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runVoidMethod ("AddView",(Object)((_p.getObject())),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth")),(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight")));
...
_l = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), _lbl.getObject());Debug.locals.put("l", _l);Debug.locals.put("l", _l);
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_mtextcolor" /*RemoteObject*/ ,_l.runMethod(true,"getTextColor"));
 BA.debugLineNum = 33;BA.debugLine="If mTextColor = xui.Color_Transparent Then mTextC";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_mtextcolor" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_Transparent")))) { 
__ref.setField ("_mtextcolor" /*RemoteObject*/ ,__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_Black"));};
...
Debug.JustUpdateDeviceLine();
_p.runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(scrollinglabel.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))),(Object)(scrollinglabel.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))));
...
try {
		Debug.PushSubsStack("getText (scrollinglabel) ","scrollinglabel",26,__ref.getField(false, "ba"),__ref,93);
...
try {
		Debug.PushSubsStack("getTextColor (scrollinglabel) ","scrollinglabel",26,__ref.getField(false, "ba"),__ref,126);
...
try {
		Debug.PushSubsStack("Initialize (scrollinglabel) ","scrollinglabel",26,__ref.getField(false, "ba"),__ref,18);
...
try {
		Debug.PushSubsStack("MeasureTextWidth (scrollinglabel) ","scrollinglabel",26,__ref.getField(false, "ba"),__ref,117);
...
try {
		Debug.PushSubsStack("setText (scrollinglabel) ","scrollinglabel",26,__ref.getField(false, "ba"),__ref,45);
...
Debug.JustUpdateDeviceLine();
_p.runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(_parent.runMethod(true,"getWidth")),(Object)(_parent.runMethod(true,"getHeight")));
...
Debug.JustUpdateDeviceLine();
_xlbl.runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(_parent.runMethod(true,"getWidth")),(Object)(_parent.runMethod(true,"getHeight")));
 };
 };
 BA.debugLineNum = 59;BA.debugLine="Dim originalTextWidth As Float = MeasureTextWidth";
Debug.JustUpdateDeviceLine();
_originaltextwidth = __ref.runClassMethod (gr.mythologia.scrollinglabel.class, "_measuretextwidth" /*RemoteObject*/ ,(Object)(_t),(Object)(__ref.getField(false,"_fnt" /*RemoteObject*/ )));Debug.locals.put("originalTextWidth", _originaltextwidth);Debug.locals.put("originalTextWidth", _originaltextwidth);
...
Debug.JustUpdateDeviceLine();
_parent.runVoidMethod ("AddView",(Object)((_p.getObject())),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(_parent.runMethod(true,"getWidth")),(Object)(_parent.runMethod(true,"getHeight")));
...
Debug.JustUpdateDeviceLine();
_lbl.runVoidMethod ("setSingleLine",scrollinglabel.__c.getField(true,"True"));
...
Debug.JustUpdateDeviceLine();
_p.runVoidMethod ("AddView",(Object)((_xlbl.getObject())),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth")),(Object)(__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight")));
 };
...
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("k",_originaltextwidth,BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth")))) { 
 BA.debugLineNum = 79;BA.debugLine="xlbl.Text = t";
Debug.JustUpdateDeviceLine();
_xlbl.runMethod(true,"setText",BA.ObjectToCharSequence(_t));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.scrollinglabel.class, "_stopscrolling" /*RemoteObject*/ );
 }else {
...
Debug.JustUpdateDeviceLine();
_width = __ref.runClassMethod (gr.mythologia.scrollinglabel.class, "_measuretextwidth" /*RemoteObject*/ ,(Object)(_duplicatetext),(Object)(__ref.getField(false,"_fnt" /*RemoteObject*/ )));Debug.locals.put("Width", _width);Debug.locals.put("Width", _width);
 BA.debugLineNum = 86;BA.debugLine="p.Width = Width";
Debug.JustUpdateDeviceLine();
_p.runMethod(true,"setWidth",BA.numberCast(int.class, _width));
 BA.debugLineNum = 87;BA.debugLine="xlbl.Width = Width";
Debug.JustUpdateDeviceLine();
_xlbl.runMethod(true,"setWidth",BA.numberCast(int.class, _width));
 BA.debugLineNum = 88;BA.debugLine="xlbl.Text = duplicateText";
Debug.JustUpdateDeviceLine();
_xlbl.runMethod(true,"setText",BA.ObjectToCharSequence(_duplicatetext));
 BA.debugLineNum = 89;BA.debugLine="StartScrolling (p, originalTextWidth)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.scrollinglabel.class, "_startscrolling" /*void*/ ,(Object)(_p),(Object)(_originaltextwidth));
 };
...
try {
		Debug.PushSubsStack("setTextColor (scrollinglabel) ","scrollinglabel",26,__ref.getField(false, "ba"),__ref,121);
...
try {
		Debug.PushSubsStack("StartScrolling (scrollinglabel) ","scrollinglabel",26,__ref.getField(false, "ba"),__ref,101);
...
public ResumableSub_StartScrolling(gr.mythologia.scrollinglabel parent,RemoteObject __ref,RemoteObject _p,RemoteObject _originalwidth) {
this.parent = parent;
this.__ref = __ref;
this._p = _p;
...
Debug.JustUpdateDeviceLine();
_p.runVoidMethod ("SetLayoutAnimated",(Object)(_duration),(Object)(BA.numberCast(int.class, -(RemoteObject.solve(new RemoteObject[] {_p.runMethod(true,"getWidth"),_originalwidth}, "-",1, 0)).<Double>get().doubleValue())),(Object)(_p.runMethod(true,"getTop")),(Object)(_p.runMethod(true,"getWidth")),(Object)(_p.runMethod(true,"getHeight")));
...
Debug.JustUpdateDeviceLine();
_p.runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(_p.runMethod(true,"getTop")),(Object)(_p.runMethod(true,"getWidth")),(Object)(_p.runMethod(true,"getHeight")));
 if (true) break;
...
try {
		Debug.PushSubsStack("StopScrolling (scrollinglabel) ","scrollinglabel",26,__ref.getField(false, "ba"),__ref,97);
