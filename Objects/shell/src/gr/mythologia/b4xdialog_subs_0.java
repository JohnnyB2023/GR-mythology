...
try {
		Debug.PushSubsStack("Background_Click (b4xdialog) ","b4xdialog",8,__ref.getField(false, "ba"),__ref,261);
...
try {
		Debug.PushSubsStack("Background_Touch (b4xdialog) ","b4xdialog",8,__ref.getField(false, "ba"),__ref,256);
...
try {
		Debug.PushSubsStack("Blur (b4xdialog) ","b4xdialog",8,__ref.getField(false, "ba"),__ref,290);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xdialog.class, "_setavg" /*RemoteObject*/ ,(Object)(_bc),(Object)(BA.numberCast(int.class, 1)),(Object)(BA.numberCast(int.class, _y)),(Object)(_clrs),(Object)(_temp));
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xdialog.class, "_setavg" /*RemoteObject*/ ,(Object)(_bc),(Object)(BA.numberCast(int.class, _x)),(Object)(BA.numberCast(int.class, _y)),(Object)(_clrs),(Object)(_temp));
 }
}Debug.locals.put("x", _x);
;
 }
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xdialog.class, "_setavg" /*RemoteObject*/ ,(Object)(_bc),(Object)(BA.numberCast(int.class, _x)),(Object)(BA.numberCast(int.class, 1)),(Object)(_clrs),(Object)(_temp));
...
try {
		Debug.PushSubsStack("Button_Click (b4xdialog) ","b4xdialog",8,__ref.getField(false, "ba"),__ref,236);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xdialog.class, "_close" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _b.runMethod(false,"getTag"))));
...
try {
		Debug.PushSubsStack("Close (b4xdialog) ","b4xdialog",8,__ref.getField(false, "ba"),__ref,242);
...
Debug.JustUpdateDeviceLine();
if (__ref.runClassMethod (gr.mythologia.b4xdialog.class, "_getvisible" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
...
try {
		Debug.PushSubsStack("CreateButton (b4xdialog) ","b4xdialog",8,__ref.getField(false, "ba"),__ref,196);
...
try {
		Debug.PushSubsStack("GetButton (b4xdialog) ","b4xdialog",8,__ref.getField(false, "ba"),__ref,218);
...
try {
		Debug.PushSubsStack("getVisible (b4xdialog) ","b4xdialog",8,__ref.getField(false, "ba"),__ref,192);
...
try {
		Debug.PushSubsStack("Initialize (b4xdialog) ","b4xdialog",8,__ref.getField(false, "ba"),__ref,36);
...
try {
		Debug.PushSubsStack("InternalAddStubToCLVIfNeeded (b4xdialog) ","b4xdialog",8,__ref.getField(false, "ba"),__ref,346);
...
try {
		Debug.PushSubsStack("InternalSetTextOrCSBuilderToLabel (b4xdialog) ","b4xdialog",8,__ref.getField(false, "ba"),__ref,342);
...
try {
		Debug.PushSubsStack("Resize (b4xdialog) ","b4xdialog",8,__ref.getField(false, "ba"),__ref,266);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xdialog.class, "_updateblur" /*RemoteObject*/ );
 };
...
try {
		Debug.PushSubsStack("SetAvg (b4xdialog) ","b4xdialog",8,__ref.getField(false, "ba"),__ref,328);
...
try {
		Debug.PushSubsStack("SetButtonState (b4xdialog) ","b4xdialog",8,__ref.getField(false, "ba"),__ref,226);
...
Debug.JustUpdateDeviceLine();
_b = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_b = __ref.runClassMethod (gr.mythologia.b4xdialog.class, "_getbutton" /*RemoteObject*/ ,(Object)(_resultcode));Debug.locals.put("b", _b);Debug.locals.put("b", _b);
...
try {
		Debug.PushSubsStack("Show (b4xdialog) ","b4xdialog",8,__ref.getField(false, "ba"),__ref,74);
...
public ResumableSub_Show(gr.mythologia.b4xdialog parent,RemoteObject __ref,RemoteObject _text,RemoteObject _yes,RemoteObject _no,RemoteObject _cancel) {
this.parent = parent;
this.__ref = __ref;
this._text = _text;
this._yes = _yes;
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("WaitFor","complete", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "b4xdialog", "show"), __ref.runClassMethod (gr.mythologia.b4xdialog.class, "_showcustom" /*RemoteObject*/ ,(Object)(_p),(Object)(_yes),(Object)(_no),(Object)(_cancel)));
this.state = 1;
return;
case 1:
//C
...
try {
		Debug.PushSubsStack("ShowCustom (b4xdialog) ","b4xdialog",8,__ref.getField(false, "ba"),__ref,97);
...
public ResumableSub_ShowCustom(gr.mythologia.b4xdialog parent,RemoteObject __ref,RemoteObject _content,RemoteObject _yes,RemoteObject _no,RemoteObject _cancel) {
this.parent = parent;
this.__ref = __ref;
...
//if
this.state = 18;
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_mparent" /*RemoteObject*/ ).runMethod(true,"getWidth"),BA.numberCast(double.class, 0)) || RemoteObject.solveBoolean("=",__ref.getField(false,"_mparent" /*RemoteObject*/ ).runMethod(true,"getHeight"),BA.numberCast(double.class, 0))) { 
this.state = 17;
}if (true) break;
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","97274520",RemoteObject.createImmutable("Warning: dialog shown with zero sized parent."),0);
 if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xdialog.class, "_createbutton" /*RemoteObject*/ ,(Object)(_cancel),(Object)(_btype));
 if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xdialog.class, "_createbutton" /*RemoteObject*/ ,(Object)(_no),(Object)(_btype));
 if (true) break;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xdialog.class, "_createbutton" /*RemoteObject*/ ,(Object)(_yes),(Object)(_btype));
 if (true) break;
...
this.state = 55;
_v = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
group77 = __ref.getField(false,"_background" /*RemoteObject*/ ).runMethod(false,"GetAllViewsRecursive");
index77 = 0;
groupLen77 = group77.runMethod(true,"getSize").<Integer>get();
Debug.locals.put("v", _v);
this.state = 68;
if (true) break;
...
this.state = 54;
_v = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), group77.runMethod(false,"Get",index77));Debug.locals.put("v", _v);}
if (true) break;
...
this.state = 59;
_v = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
group81 = __ref.getField(false,"_background" /*RemoteObject*/ ).runMethod(false,"GetAllViewsRecursive");
index81 = 0;
...
this.state = 58;
_v = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), group81.runMethod(false,"Get",index81));Debug.locals.put("v", _v);}
if (true) break;
...
try {
		Debug.PushSubsStack("ShowTemplate (b4xdialog) ","b4xdialog",8,__ref.getField(false, "ba"),__ref,65);
...
public ResumableSub_ShowTemplate(gr.mythologia.b4xdialog parent,RemoteObject __ref,RemoteObject _dialogtemplate,RemoteObject _yes,RemoteObject _no,RemoteObject _cancel) {
this.parent = parent;
this.__ref = __ref;
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("WaitFor","complete", __ref.getField(false, "ba"), anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "b4xdialog", "showtemplate"), __ref.runClassMethod (gr.mythologia.b4xdialog.class, "_showcustom" /*RemoteObject*/ ,(Object)(_content),(Object)(_yes),(Object)(_no),(Object)(_cancel)));
this.state = 1;
return;
case 1:
//C
...
try {
		Debug.PushSubsStack("Stub_Click (b4xdialog) ","b4xdialog",8,__ref.getField(false, "ba"),__ref,352);
...
try {
		Debug.PushSubsStack("UpdateBlur (b4xdialog) ","b4xdialog",8,__ref.getField(false, "ba"),__ref,277);
...
Debug.JustUpdateDeviceLine();
_blurred = __ref.runClassMethod (gr.mythologia.b4xdialog.class, "_blur" /*RemoteObject*/ ,(Object)(_source));Debug.locals.put("blurred", _blurred);Debug.locals.put("blurred", _blurred);
