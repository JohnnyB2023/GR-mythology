...
try {
		Debug.PushSubsStack("Base_Resize (b4xloadingindicator) ","b4xloadingindicator",13,__ref.getField(false, "ba"),__ref,37);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xloadingindicator.class, "_mainloop" /*void*/ );
...
b4xloadingindicator._indicatorcolor = RemoteObject.createImmutable(0);__ref.setField("_indicatorcolor",b4xloadingindicator._indicatorcolor);
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xloadingindicator) ","b4xloadingindicator",13,__ref.getField(false, "ba"),__ref,26);
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_indicatorcolor" /*RemoteObject*/ ,__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"PaintOrColorToColor",(Object)(_props.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("Color")))))));
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_duration" /*RemoteObject*/ ,BA.numberCast(int.class, _props.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("Duration"))))));
 BA.debugLineNum = 32;BA.debugLine="SetStyle(style)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xloadingindicator.class, "_setstyle" /*RemoteObject*/ ,(Object)(_style));
...
try {
		Debug.PushSubsStack("Draw_Arc1 (b4xloadingindicator) ","b4xloadingindicator",13,__ref.getField(false, "ba"),__ref,112);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvs" /*RemoteObject*/ ).runVoidMethod ("DrawRect",(Object)(__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"getTargetRect")),(Object)(__ref.getField(true,"_indicatorcolor" /*RemoteObject*/ )),(Object)(b4xloadingindicator.__c.getField(true,"True")),(Object)(BA.numberCast(float.class, 0)));
...
try {
		Debug.PushSubsStack("Draw_Arc2 (b4xloadingindicator) ","b4xloadingindicator",13,__ref.getField(false, "ba"),__ref,125);
...
try {
		Debug.PushSubsStack("Draw_FiveLines1 (b4xloadingindicator) ","b4xloadingindicator",13,__ref.getField(false, "ba"),__ref,102);
...
try {
		Debug.PushSubsStack("Draw_PacMan (b4xloadingindicator) ","b4xloadingindicator",13,__ref.getField(false, "ba"),__ref,138);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvs" /*RemoteObject*/ ).runVoidMethod ("DrawCircle",(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"getTargetRect").runMethod(true,"getWidth"),_dotr,_progress,(RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"getTargetRect").runMethod(true,"getCenterX"),b4xloadingindicator.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 10)))}, "-",1, 0))}, "--*",2, 0))),(Object)(__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"getTargetRect").runMethod(true,"getCenterY")),(Object)(BA.numberCast(float.class, _dotr)),(Object)(__ref.runClassMethod (gr.mythologia.b4xloadingindicator.class, "_setalpha" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_indicatorcolor" /*RemoteObject*/ )),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(255),RemoteObject.createImmutable(200),_progress}, "-*",1, 0))))),(Object)(b4xloadingindicator.__c.getField(true,"True")),(Object)(BA.numberCast(float.class, 0)));
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvs" /*RemoteObject*/ ).runVoidMethod ("DrawCircle",(Object)(BA.numberCast(float.class, _cx)),(Object)(BA.numberCast(float.class, _cy)),(Object)(BA.numberCast(float.class, _r)),(Object)(__ref.getField(true,"_indicatorcolor" /*RemoteObject*/ )),(Object)(b4xloadingindicator.__c.getField(true,"True")),(Object)(BA.numberCast(float.class, 0)));
 }else {
...
try {
		Debug.PushSubsStack("Draw_SingleCircle (b4xloadingindicator) ","b4xloadingindicator",13,__ref.getField(false, "ba"),__ref,92);
...
try {
		Debug.PushSubsStack("Draw_ThreeCircles1 (b4xloadingindicator) ","b4xloadingindicator",13,__ref.getField(false, "ba"),__ref,73);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_cvs" /*RemoteObject*/ ).runVoidMethod ("DrawCircle",(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"getTargetRect").runMethod(true,"getCenterX"),_r,b4xloadingindicator.__c.runMethod(true,"SinD",(Object)(BA.numberCast(double.class, _alpha)))}, "+*",1, 0))),(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_cvs" /*RemoteObject*/ ).runMethod(false,"getTargetRect").runMethod(true,"getCenterY"),_r,b4xloadingindicator.__c.runMethod(true,"CosD",(Object)(BA.numberCast(double.class, _alpha)))}, "+*",1, 0))),(Object)(BA.numberCast(float.class, b4xloadingindicator.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 7))))),(Object)(__ref.getField(true,"_indicatorcolor" /*RemoteObject*/ )),(Object)(b4xloadingindicator.__c.getField(true,"True")),(Object)(BA.numberCast(float.class, b4xloadingindicator.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 1))))));
 }
}Debug.locals.put("i", _i);
;
...
try {
		Debug.PushSubsStack("Draw_ThreeCircles2 (b4xloadingindicator) ","b4xloadingindicator",13,__ref.getField(false, "ba"),__ref,83);
...
try {
		Debug.PushSubsStack("Hide (b4xloadingindicator) ","b4xloadingindicator",13,__ref.getField(false, "ba"),__ref,68);
...
try {
		Debug.PushSubsStack("Initialize (b4xloadingindicator) ","b4xloadingindicator",13,__ref.getField(false, "ba"),__ref,20);
...
try {
		Debug.PushSubsStack("MainLoop (b4xloadingindicator) ","b4xloadingindicator",13,__ref.getField(false, "ba"),__ref,49);
...
public ResumableSub_MainLoop(gr.mythologia.b4xloadingindicator parent,RemoteObject __ref) {
this.parent = parent;
this.__ref = __ref;
}
...
try {
		Debug.PushSubsStack("SetAlpha (b4xloadingindicator) ","b4xloadingindicator",13,__ref.getField(false, "ba"),__ref,98);
...
public static RemoteObject  _setstyle(RemoteObject __ref,RemoteObject _style) throws Exception{
try {
		Debug.PushSubsStack("SetStyle (b4xloadingindicator) ","b4xloadingindicator",13,__ref.getField(false, "ba"),__ref,44);
if (RapidSub.canDelegate("setstyle")) { return __ref.runUserSub(false, "b4xloadingindicator","setstyle", __ref, _style);}
...
try {
		Debug.PushSubsStack("Show (b4xloadingindicator) ","b4xloadingindicator",13,__ref.getField(false, "ba"),__ref,63);
