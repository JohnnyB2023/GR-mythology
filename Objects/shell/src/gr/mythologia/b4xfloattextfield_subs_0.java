...
try {
		Debug.PushSubsStack("Base_Resize (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,199);
...
Debug.locals.put("Height", _height);
 BA.debugLineNum = 199;BA.debugLine="Public Sub Base_Resize (Width As Double, Height As";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 200;BA.debugLine="mTextField.SetLayoutAnimated(0, 0, 0, Width, Heig";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mtextfield" /*RemoteObject*/ ).runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, _width)),(Object)(BA.numberCast(int.class, _height)));
 BA.debugLineNum = 201;BA.debugLine="Dim FirstDistance As Int = 2dip";
Debug.JustUpdateDeviceLine();
_firstdistance = b4xfloattextfield.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)));Debug.locals.put("FirstDistance", _firstdistance);Debug.locals.put("FirstDistance", _firstdistance);
 BA.debugLineNum = 202;BA.debugLine="If Multiline And xui.IsB4J Then FirstDistance = 2";
Debug.JustUpdateDeviceLine();
...
_firstdistance = b4xfloattextfield.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 22)));Debug.locals.put("FirstDistance", _firstdistance);};
 BA.debugLineNum = 203;BA.debugLine="If lblV.IsInitialized Then";
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_lblv" /*RemoteObject*/ ).runMethod(true,"IsInitialized").<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 204;BA.debugLine="lblV.SetLayoutAnimated(0, Width - lblV.Width - F";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_lblv" /*RemoteObject*/ ).runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_width,__ref.getField(false,"_lblv" /*RemoteObject*/ ).runMethod(true,"getWidth"),_firstdistance}, "--",2, 0))),(Object)(BA.numberCast(int.class, 0)),(Object)(__ref.getField(false,"_lblv" /*RemoteObject*/ ).runMethod(true,"getWidth")),(Object)(BA.numberCast(int.class, _height)));
 BA.debugLineNum = 205;BA.debugLine="FirstDistance = FirstDistance + lblV.Width + 2di";
Debug.JustUpdateDeviceLine();
_firstdistance = RemoteObject.solve(new RemoteObject[] {_firstdistance,__ref.getField(false,"_lblv" /*RemoteObject*/ ).runMethod(true,"getWidth"),b4xfloattextfield.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))}, "++",2, 1);Debug.locals.put("FirstDistance", _firstdistance);
 ...
 BA.debugLineNum = 207;BA.debugLine="If lblClear.IsInitialized Then";
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_lblclear" /*RemoteObject*/ ).runMethod(true,"IsInitialized").<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 208;BA.debugLine="lblClear.SetLayoutAnimated(0, Width - lblClear.W";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_lblclear" /*RemoteObject*/ ).runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_width,__ref.getField(false,"_lblclear" /*RemoteObject*/ ).runMethod(true,"getWidth"),_firstdistance}, "--",2, 0))),(Object)(BA.numberCast(int.class, 0)),(Object)(__ref.getField(false,"_lblclear" /*RemoteObject*/ ).runMethod(true,"getWidth")),(Object)(BA.numberCast(int.class, _height)));
 ...
 BA.debugLineNum = 210;BA.debugLine="UpdateLabel(mTextField.Text, True)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_updatelabel" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_mtextfield" /*RemoteObject*/ ).runMethod(true,"getText")),(Object)(b4xfloattextfield.__c.getField(true,"True")));
...
b4xfloattextfield._mnexttextfield = RemoteObject.createNew ("gr.mythologia.b4xfloattextfield");__ref.setField("_mnexttextfield",b4xfloattextfield._mnexttextfield);
...
b4xfloattextfield._menabled = b4xfloattextfield.__c.getField(true,"True");__ref.setField("_menabled",b4xfloattextfield._menabled);
 //BA.debugLineNum = 49;BA.debugLine="Public ShowAcceptButtonWhenEmpty As Boolean";
b4xfloattextfield._showacceptbuttonwhenempty = RemoteObject.createImmutable(false);__ref.setField("_showacceptbuttonwhenempty",b4xfloattextfield._showacceptbuttonwhenempty);
 //BA.debugLineNum = 50;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _createacceptbutton(RemoteObject __ref) throws Exception{
try {
		Debug.PushSubsStack("CreateAcceptButton (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,128);
...
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 129;BA.debugLine="If mProps.GetDefault(\"ShowAccept\", True) = False";
Debug.JustUpdateDeviceLine();
...
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 130;BA.debugLine="lblV = CreateButton(Chr(0xE5CA))";
Debug.JustUpdateDeviceLine();
__ref.setField ("_lblv" /*RemoteObject*/ ,__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_createbutton" /*RemoteObject*/ ,(Object)(BA.ObjectToString(b4xfloattextfield.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, ((int)0xe5ca))))))));
 BA.debugLineNum = 131;BA.debugLine="lblV.Tag = \"v\"";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("CreateBitmap (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,260);
...
Debug.locals.put("Fnt", _fnt);
 BA.debugLineNum = 260;BA.debugLine="Private Sub CreateBitmap(r As B4XRect, Color As In";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 261;BA.debugLine="Dim p As B4XView = xui.CreatePanel(\"\")";
Debug.JustUpdateDeviceLine();
...
_p = __ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(false,"CreatePanel",__ref.getField(false, "ba"),(Object)(RemoteObject.createImmutable("")));Debug.locals.put("p", _p);Debug.locals.put("p", _p);
 BA.debugLineNum = 262;BA.debugLine="p.SetLayoutAnimated(0, 0, 0, Max(1, r.Width + 2di";
Debug.JustUpdateDeviceLine();
_p.runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, b4xfloattextfield.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 1)),(Object)(RemoteObject.solve(new RemoteObject[] {_r.runMethod(true,"getWidth"),b4xfloattextfield.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))}, "+",1, 0))))),(Object)(BA.numberCast(int.class, b4xfloattextfield.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 1)),(Object)(RemoteObject.solve(new RemoteObject[] {_r.runMethod(true,"getHeight"),b4xfloattextfield.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))}, "+",1, 0))))));
 BA.debugLineNum = 263;BA.debugLine="Dim c As B4XCanvas";
Debug.JustUpdateDeviceLine();
_c = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XCanvas");Debug.locals.put("c", _c);
 BA.debugLineNum = 264;BA.debugLine="c.Initialize(p)";
Debug.JustUpdateDeviceLine();
_c.runVoidMethod ("Initialize",(Object)(_p));
 BA.debugLineNum = 265;BA.debugLine="Dim BaseLine As Int = p.Height / 2 - r.Height / 2";
Debug.JustUpdateDeviceLine();
_baseline = BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {_p.runMethod(true,"getHeight"),RemoteObject.createImmutable(2),_r.runMethod(true,"getHeight"),RemoteObject.createImmutable(2),_r.runMethod(true,"getTop")}, "/-/-",2, 0));Debug.locals.put("BaseLine", _baseline);Debug.locals.put("BaseLine", _baseline);
 BA.debugLineNum = 266;BA.debugLine="c.DrawText(HintText, p.Width / 2, BaseLine, Fnt,";
Debug.JustUpdateDeviceLine();
_c.runVoidMethod ("DrawText",__ref.getField(false, "ba"),(Object)(__ref.getField(true,"_hinttext" /*RemoteObject*/ )),(Object)(BA.numberCast(float.class, RemoteObject.solve(new RemoteObject[] {_p.runMethod(true,"getWidth"),RemoteObject.createImmutable(2)}, "/",0, 0))),(Object)(BA.numberCast(float.class, _baseline)),(Object)(_fnt),(Object)(_color),(Object)(BA.getEnumFromString(BA.getDeviceClass("android.graphics.Paint.Align"),RemoteObject.createImmutable("CENTER"))));
 BA.debugLineNum = 267;BA.debugLine="Dim bmp As B4XBitmap = c.CreateBitmap";
Debug.JustUpdateDeviceLine();
...
_bmp = _c.runMethod(false,"CreateBitmap");Debug.locals.put("bmp", _bmp);Debug.locals.put("bmp", _bmp);
 BA.debugLineNum = 268;BA.debugLine="c.Release";
Debug.JustUpdateDeviceLine();
_c.runVoidMethod ("Release");
 BA.debugLineNum = 269;BA.debugLine="Return bmp";
Debug.JustUpdateDeviceLine();
if (true) return _bmp;
...
try {
		Debug.PushSubsStack("CreateButton (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,185);
...
Debug.locals.put("Text", _text);
 BA.debugLineNum = 185;BA.debugLine="Private Sub CreateButton (Text As String) As B4XVi";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 186;BA.debugLine="Dim lc As Label";
Debug.JustUpdateDeviceLine();
_lc = RemoteObject.createNew ("anywheresoftware.b4a.objects.LabelWrapper");Debug.locals.put("lc", _lc);
 BA.debugLineNum = 187;BA.debugLine="lc.Initialize(\"lc\")";
Debug.JustUpdateDeviceLine();
_lc.runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)(RemoteObject.createImmutable("lc")));
 BA.debugLineNum = 188;BA.debugLine="Dim x As B4XView = lc";
Debug.JustUpdateDeviceLine();
...
_x = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), _lc.getObject());Debug.locals.put("x", _x);Debug.locals.put("x", _x);
 BA.debugLineNum = 189;BA.debugLine="x = lc";
Debug.JustUpdateDeviceLine();
_x = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), _lc.getObject());Debug.locals.put("x", _x);
 BA.debugLineNum = 190;BA.debugLine="x.Font = xui.CreateMaterialIcons(20)";
Debug.JustUpdateDeviceLine();
...
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runVoidMethod ("AddView",(Object)((_x.getObject())),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(b4xfloattextfield.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 30)))),(Object)(b4xfloattextfield.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 30)))));
 BA.debugLineNum = 196;BA.debugLine="Return x";
Debug.JustUpdateDeviceLine();
if (true) return _x;
...
try {
		Debug.PushSubsStack("CreateClearButton (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,120);
...
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 121;BA.debugLine="If mProps.GetDefault(\"ShowClear\", True) = False T";
Debug.JustUpdateDeviceLine();
...
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 122;BA.debugLine="If lblClear.IsInitialized And lblClear.Parent.IsI";
Debug.JustUpdateDeviceLine();
...
__ref.getField(false,"_lblclear" /*RemoteObject*/ ).runVoidMethod ("RemoveViewFromParent");};
 BA.debugLineNum = 123;BA.debugLine="lblClear = CreateButton(Chr(0xE14C))";
Debug.JustUpdateDeviceLine();
__ref.setField ("_lblclear" /*RemoteObject*/ ,__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_createbutton" /*RemoteObject*/ ,(Object)(BA.ObjectToString(b4xfloattextfield.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, ((int)0xe14c))))))));
 BA.debugLineNum = 124;BA.debugLine="lblClear.Tag = \"clear\"";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("CreateRevealButton (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,135);
...
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 136;BA.debugLine="lblClear = CreateButton(Chr(0xE8F4))";
Debug.JustUpdateDeviceLine();
__ref.setField ("_lblclear" /*RemoteObject*/ ,__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_createbutton" /*RemoteObject*/ ,(Object)(BA.ObjectToString(b4xfloattextfield.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, ((int)0xe8f4))))))));
 BA.debugLineNum = 137;BA.debugLine="lblClear.Tag = \"reveal\"";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("CreateTextField (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,331);
...
Debug.locals.put("Password", _password);
 BA.debugLineNum = 331;BA.debugLine="Private Sub CreateTextField (Password As Boolean)";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 347;BA.debugLine="Dim tf As EditText";
Debug.JustUpdateDeviceLine();
_tf = RemoteObject.createNew ("anywheresoftware.b4a.objects.EditTextWrapper");Debug.locals.put("tf", _tf);
 BA.debugLineNum = 348;BA.debugLine="tf.Initialize(\"tf\")";
Debug.JustUpdateDeviceLine();
_tf.runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)(RemoteObject.createImmutable("tf")));
 BA.debugLineNum = 349;BA.debugLine="tf.SingleLine = Not(Multiline)";
Debug.JustUpdateDeviceLine();
_tf.runVoidMethod ("setSingleLine",b4xfloattextfield.__c.runMethod(true,"Not",(Object)(__ref.getField(true,"_multiline" /*RemoteObject*/ ))));
 BA.debugLineNum = 350;BA.debugLine="tf.PasswordMode = Password";
Debug.JustUpdateDeviceLine();
_tf.runVoidMethod ("setPasswordMode",_password);
 BA.debugLineNum = 351;BA.debugLine="If Password Then";
Debug.JustUpdateDeviceLine();
if (_password.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 352;BA.debugLine="If KeyboardType <> \"Text\" Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("!",__ref.getField(true,"_keyboardtype" /*RemoteObject*/ ),BA.ObjectToString("Text"))) { 
 BA.debugLineNum = 353;BA.debugLine="tf.InputType = Bit.Or(tf.INPUT_TYPE_NUMBERS, 16";
Debug.JustUpdateDeviceLine();
_tf.runMethod(true,"setInputType",b4xfloattextfield.__c.getField(false,"Bit").runMethod(true,"Or",(Object)(_tf.getField(true,"INPUT_TYPE_NUMBERS")),(Object)(BA.numberCast(int.class, 16))));
 ...
 BA.debugLineNum = 355;BA.debugLine="tf.InputType = Bit.Or(0x00000080, 0x00080000) '";
Debug.JustUpdateDeviceLine();
_tf.runMethod(true,"setInputType",b4xfloattextfield.__c.getField(false,"Bit").runMethod(true,"Or",(Object)(BA.numberCast(int.class, ((int)0x00000080))),(Object)(BA.numberCast(int.class, ((int)0x00080000)))));
 ...
 BA.debugLineNum = 358;BA.debugLine="Select KeyboardType";
Debug.JustUpdateDeviceLine();
...
case 0: {
 BA.debugLineNum = 360;BA.debugLine="tf.InputType = tf.INPUT_TYPE_NUMBERS";
Debug.JustUpdateDeviceLine();
_tf.runMethod(true,"setInputType",_tf.getField(true,"INPUT_TYPE_NUMBERS"));
 break; }
case 1: {
 BA.debugLineNum = 362;BA.debugLine="tf.InputType = tf.INPUT_TYPE_DECIMAL_NUMBERS";
Debug.JustUpdateDeviceLine();
...
;
 ...
 BA.debugLineNum = 365;BA.debugLine="Return tf";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("CreateTextFieldAll (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,112);
...
Debug.locals.put("TextColor", _textcolor);
 BA.debugLineNum = 112;BA.debugLine="Private Sub CreateTextFieldAll (PasswordMode As Bo";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 113;BA.debugLine="mTextField = CreateTextField (PasswordMode)";
Debug.JustUpdateDeviceLine();
__ref.setField ("_mtextfield" /*RemoteObject*/ ,__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_createtextfield" /*RemoteObject*/ ,(Object)(_passwordmode)));
 BA.debugLineNum = 114;BA.debugLine="mTextField.Font = Font1";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mtextfield" /*RemoteObject*/ ).runMethod(false,"setFont",_font1);
 BA.debugLineNum = 115;BA.debugLine="mTextField.TextColor = TextColor";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mtextfield" /*RemoteObject*/ ).runMethod(true,"setTextColor",_textcolor);
 BA.debugLineNum = 116;BA.debugLine="setNextField(mNextTextField)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_setnextfield" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_mnexttextfield" /*RemoteObject*/ )));
 BA.debugLineNum = 117;BA.debugLine="mBase.AddView(mTextField, 0, 0, 0, 0)";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("DesignerCreateView (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,70);
...
Debug.locals.put("Props", _props);
 BA.debugLineNum = 70;BA.debugLine="Public Sub DesignerCreateView (Base As Object, lbl";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 71;BA.debugLine="mBase = Base";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mbase" /*RemoteObject*/ ).setObject (_base);
 BA.debugLineNum = 72;BA.debugLine="Tag = mBase.Tag : mBase.Tag = Me";
Debug.JustUpdateDeviceLine();
__ref.setField ("_tag" /*RemoteObject*/ ,__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(false,"getTag"));
 BA.debugLineNum = 72;BA.debugLine="Tag = mBase.Tag : mBase.Tag = Me";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(false,"setTag",__ref);
 BA.debugLineNum = 73;BA.debugLine="mBase.SetColorAndBorder(xui.Color_Transparent, 0,";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runVoidMethod ("SetColorAndBorder",(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_Transparent")),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)));
 BA.debugLineNum = 74;BA.debugLine="mProps = Props";
Debug.JustUpdateDeviceLine();
__ref.setField ("_mprops" /*RemoteObject*/ ,_props);
 BA.debugLineNum = 75;BA.debugLine="Dim PassedLabel As B4XView = lbl";
Debug.JustUpdateDeviceLine();
...
__ref.setField ("_keyboardtype" /*RemoteObject*/ ,BA.ObjectToString(_props.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("KeyboardType"))),(Object)((RemoteObject.createImmutable("Text"))))));
 BA.debugLineNum = 85;BA.debugLine="HintColor = xui.PaintOrColorToColor(Props.Get(\"Hi";
Debug.JustUpdateDeviceLine();
__ref.setField ("_hintcolor" /*RemoteObject*/ ,__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"PaintOrColorToColor",(Object)(_props.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("HintColor")))))));
 BA.debugLineNum = 86;BA.debugLine="NonFocusedHintColor = xui.PaintOrColorToColor(Pro";
Debug.JustUpdateDeviceLine();
__ref.setField ("_nonfocusedhintcolor" /*RemoteObject*/ ,__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"PaintOrColorToColor",(Object)(_props.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("NonFocusedHintColor")))))));
 BA.debugLineNum = 88;BA.debugLine="HintText = Props.Get(\"Hint\")";
Debug.JustUpdateDeviceLine();
__ref.setField ("_hinttext" /*RemoteObject*/ ,BA.ObjectToString(_props.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("Hint"))))));
 BA.debugLineNum = 89;BA.debugLine="HintFont = PassedLabel.Font";
Debug.JustUpdateDeviceLine();
__ref.setField ("_hintfont" /*RemoteObject*/ ,_passedlabel.runMethod(false,"getFont"));
 BA.debugLineNum = 90;BA.debugLine="Dim PasswordMode As Boolean = Props.GetDefault(\"P";
Debug.JustUpdateDeviceLine();
_passwordmode = BA.ObjectToBoolean(_props.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("PasswordField"))),(Object)((b4xfloattextfield.__c.getField(true,"False")))));Debug.locals.put("PasswordMode", _passwordmode);Debug.locals.put("PasswordMode", _passwordmode);
 BA.debugLineNum = 91;BA.debugLine="Multiline = Props.GetDefault(\"Multiline\", False)";
Debug.JustUpdateDeviceLine();
__ref.setField ("_multiline" /*RemoteObject*/ ,BA.ObjectToBoolean(_props.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("Multiline"))),(Object)((b4xfloattextfield.__c.getField(true,"False"))))));
 BA.debugLineNum = 92;BA.debugLine="If PasswordMode And Multiline Then";
Debug.JustUpdateDeviceLine();
...
Debug.JustUpdateDeviceLine();
b4xfloattextfield.__c.runVoidMethod ("LogImpl","98454168",RemoteObject.createImmutable("Multiline not supported with password mode."),0);
 };
 BA.debugLineNum = 96;BA.debugLine="CreateTextFieldAll(PasswordMode, PassedLabel.Font";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_createtextfieldall" /*RemoteObject*/ ,(Object)(_passwordmode),(Object)(_passedlabel.runMethod(false,"getFont")),(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"PaintOrColorToColor",(Object)((_lbl.runMethod(true,"getTextColor"))))));
 BA.debugLineNum = 98;BA.debugLine="mBase.AddView(HintImageView, 0, 0, 0, 0)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mbase" /*RemoteObject*/ ).runVoidMethod ("AddView",(Object)((__ref.getField(false,"_hintimageview" /*RemoteObject*/ ).getObject())),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)));
 BA.debugLineNum = 99;BA.debugLine="Dim p As B4XView = xui.CreatePanel(\"\")";
Debug.JustUpdateDeviceLine();
_p = RemoteObject.createNew ("anywheresoftware.b4a.objects.B4XViewWrapper");
_p = __ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(false,"CreatePanel",__ref.getField(false, "ba"),(Object)(RemoteObject.createImmutable("")));Debug.locals.put("p", _p);Debug.locals.put("p", _p);
 BA.debugLineNum = 100;BA.debugLine="p.SetLayoutAnimated(0, 0, 0, 2dip, 2dip)";
Debug.JustUpdateDeviceLine();
_p.runVoidMethod ("SetLayoutAnimated",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(b4xfloattextfield.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))),(Object)(b4xfloattextfield.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2)))));
 BA.debugLineNum = 101;BA.debugLine="MeasuringCanvas.Initialize(p)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_measuringcanvas" /*RemoteObject*/ ).runVoidMethod ("Initialize",(Object)(_p));
 BA.debugLineNum = 102;BA.debugLine="Update";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_update" /*RemoteObject*/ );
 BA.debugLineNum = 103;BA.debugLine="If PasswordMode And Props.GetDefault(\"ShowRevealB";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(".",_passwordmode) && RemoteObject.solveBoolean(".",BA.ObjectToBoolean(_props.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("ShowRevealButton"))),(Object)((b4xfloattextfield.__c.getField(true,"False"))))))) { 
 BA.debugLineNum = 104;BA.debugLine="CreateRevealButton";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_createrevealbutton" /*RemoteObject*/ );
 }else {
 BA.debugLineNum = 106;BA.debugLine="CreateClearButton";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_createclearbutton" /*RemoteObject*/ );
 };
 BA.debugLineNum = 108;BA.debugLine="CreateAcceptButton";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_createacceptbutton" /*RemoteObject*/ );
 BA.debugLineNum = 109;BA.debugLine="Base_Resize(mBase.Width, mBase.Height)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_base_resize" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"))));
...
try {
		Debug.PushSubsStack("getEnabled (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,412);
...
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 413;BA.debugLine="Return mEnabled";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("getNextField (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,298);
...
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 299;BA.debugLine="Return mNextTextField";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("getText (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,391);
...
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 392;BA.debugLine="Return mTextField.Text";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("getTextField (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,459);
...
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 460;BA.debugLine="Return mTextField";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("ime_HandleAction (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,317);
...
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 318;BA.debugLine="tf_EnterPressed";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_tf_enterpressed" /*RemoteObject*/ );
 BA.debugLineNum = 319;BA.debugLine="If mNextTextField.IsInitialized Then Return True";
Debug.JustUpdateDeviceLine();
...
if (true) return b4xfloattextfield.__c.getField(true,"True");};
 BA.debugLineNum = 320;BA.debugLine="Return False";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("Initialize (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,52);
...
__ref.setField ("_mcallback" /*RemoteObject*/ ,_callback);
 BA.debugLineNum = 55;BA.debugLine="If xui.IsB4A Then";
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"getIsB4A").<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 56;BA.debugLine="HintLabelLargeOffsetX = 6dip";
Debug.JustUpdateDeviceLine();
__ref.setField ("_hintlabellargeoffsetx" /*RemoteObject*/ ,b4xfloattextfield.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 6))));
 ...
 BA.debugLineNum = 58;BA.debugLine="HintLabelLargeOffsetX = 12dip";
Debug.JustUpdateDeviceLine();
__ref.setField ("_hintlabellargeoffsetx" /*RemoteObject*/ ,b4xfloattextfield.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 12))));
 ...
 BA.debugLineNum = 61;BA.debugLine="IME.Initialize(\"ime\")";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_ime" /*RemoteObject*/ ).runVoidMethod ("Initialize",(Object)(RemoteObject.createImmutable("ime")));
 BA.debugLineNum = 67;BA.debugLine="ShowAcceptButtonWhenEmpty = xui.IsB4i";
Debug.JustUpdateDeviceLine();
__ref.setField ("_showacceptbuttonwhenempty" /*RemoteObject*/ ,__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"getIsB4i"));
...
try {
		Debug.PushSubsStack("lc_Click (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,416);
...
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 417;BA.debugLine="If mEnabled = False Then Return";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_menabled" /*RemoteObject*/ ),b4xfloattextfield.__c.getField(true,"False"))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 418;BA.debugLine="Dim btn As B4XView = Sender";
Debug.JustUpdateDeviceLine();
...
_btn = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), b4xfloattextfield.__c.runMethod(false,"Sender",__ref.getField(false, "ba")));Debug.locals.put("btn", _btn);Debug.locals.put("btn", _btn);
 BA.debugLineNum = 419;BA.debugLine="Select btn.Tag";
Debug.JustUpdateDeviceLine();
...
case 0: {
 BA.debugLineNum = 421;BA.debugLine="setText(\"\")";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_settext" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("")));
 break; }
case 1: {
 BA.debugLineNum = 423;BA.debugLine="SwitchFromPasswordToRegular (True)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_switchfrompasswordtoregular" /*void*/ ,(Object)(b4xfloattextfield.__c.getField(true,"True")));
 break; }
case 2: {
 BA.debugLineNum = 425;BA.debugLine="SwitchFromPasswordToRegular(False)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_switchfrompasswordtoregular" /*void*/ ,(Object)(b4xfloattextfield.__c.getField(true,"False")));
 break; }
case 3: {
 BA.debugLineNum = 427;BA.debugLine="tf_EnterPressed";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_tf_enterpressed" /*RemoteObject*/ );
 BA.debugLineNum = 428;BA.debugLine="If mNextTextField.IsInitialized = False Or mNex";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("RequestFocusAndShowKeyboard (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,464);
...
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 465;BA.debugLine="mTextField.RequestFocus";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mtextfield" /*RemoteObject*/ ).runVoidMethod ("RequestFocus");
 BA.debugLineNum = 467;BA.debugLine="IME.ShowKeyboard(mTextField)";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("setEnabled (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,406);
...
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 407;BA.debugLine="mEnabled = b";
Debug.JustUpdateDeviceLine();
__ref.setField ("_menabled" /*RemoteObject*/ ,_b);
 BA.debugLineNum = 408;BA.debugLine="mTextField.Enabled = b";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mtextfield" /*RemoteObject*/ ).runMethod(true,"setEnabled",_b);
 BA.debugLineNum = 409;BA.debugLine="UpdateLabel(mTextField.Text, False)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_updatelabel" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_mtextfield" /*RemoteObject*/ ).runMethod(true,"getText")),(Object)(b4xfloattextfield.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("setNextField (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,302);
...
Debug.locals.put("Field", _field);
 BA.debugLineNum = 302;BA.debugLine="Public Sub setNextField (Field As B4XFloatTextFiel";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 303;BA.debugLine="If Field.IsInitialized = False Then Return";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_field.runMethod(true,"IsInitialized" /*RemoteObject*/ ),b4xfloattextfield.__c.getField(true,"False"))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 305;BA.debugLine="If Multiline = False Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_multiline" /*RemoteObject*/ ),b4xfloattextfield.__c.getField(true,"False"))) { 
 BA.debugLineNum = 306;BA.debugLine="If Field <> Me Then";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("!",_field,(__ref))) { 
 BA.debugLineNum = 307;BA.debugLine="IME.AddHandleActionEvent(mTextField)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_ime" /*RemoteObject*/ ).runVoidMethod ("AddHandleActionEvent",(Object)((__ref.getField(false,"_mtextfield" /*RemoteObject*/ ).getObject())),__ref.getField(false, "ba"));
 ...
 BA.debugLineNum = 309;BA.debugLine="Dim et As EditText = mTextField";
Debug.JustUpdateDeviceLine();
...
_et = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.EditTextWrapper"), __ref.getField(false,"_mtextfield" /*RemoteObject*/ ).getObject());Debug.locals.put("et", _et);Debug.locals.put("et", _et);
 BA.debugLineNum = 310;BA.debugLine="et.ForceDoneButton = True";
Debug.JustUpdateDeviceLine();
_et.runVoidMethod ("setForceDoneButton",b4xfloattextfield.__c.getField(true,"True"));
 };
 BA.debugLineNum = 313;BA.debugLine="Dim o As Object = Field";
Debug.JustUpdateDeviceLine();
_o = (_field);Debug.locals.put("o", _o);Debug.locals.put("o", _o);
 BA.debugLineNum = 314;BA.debugLine="mNextTextField = o";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("setText (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,395);
...
Debug.locals.put("s", _s);
 BA.debugLineNum = 395;BA.debugLine="Public Sub setText(s As String)";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 396;BA.debugLine="Dim old As String = mTextField.Text 'ignore";
Debug.JustUpdateDeviceLine();
_old = __ref.getField(false,"_mtextfield" /*RemoteObject*/ ).runMethod(true,"getText");Debug.locals.put("old", _old);Debug.locals.put("old", _old);
 BA.debugLineNum = 397;BA.debugLine="mTextField.Text = s";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mtextfield" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(_s));
 BA.debugLineNum = 399;BA.debugLine="If IsPaused(Me) Then tf_TextChanged(old, s)";
Debug.JustUpdateDeviceLine();
if (b4xfloattextfield.__c.runMethod(true,"IsPaused",__ref.getField(false, "ba"),(Object)(__ref)).<Boolean>get().booleanValue()) { 
__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_tf_textchanged" /*RemoteObject*/ ,(Object)(_old),(Object)(_s));};
...
try {
		Debug.PushSubsStack("SwitchFromPasswordToRegular (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,140);
...
public ResumableSub_SwitchFromPasswordToRegular(gr.mythologia.b4xfloattextfield parent,RemoteObject __ref,RemoteObject _toregular) {
this.parent = parent;
this.__ref = __ref;
...
RemoteObject __ref;
gr.mythologia.b4xfloattextfield parent;
...
Debug.locals.put("ToRegular", _toregular);
 BA.debugLineNum = 141;BA.debugLine="Dim text As String = mTextField.Text";
Debug.JustUpdateDeviceLine();
_text = __ref.getField(false,"_mtextfield" /*RemoteObject*/ ).runMethod(true,"getText");Debug.locals.put("text", _text);Debug.locals.put("text", _text);
 BA.debugLineNum = 142;BA.debugLine="Dim textcolor As Int = mTextField.TextColor";
Debug.JustUpdateDeviceLine();
_textcolor = __ref.getField(false,"_mtextfield" /*RemoteObject*/ ).runMethod(true,"getTextColor");Debug.locals.put("textcolor", _textcolor);Debug.locals.put("textcolor", _textcolor);
 BA.debugLineNum = 143;BA.debugLine="Dim Font1 As B4XFont = mTextField.Font";
Debug.JustUpdateDeviceLine();
_font1 = __ref.getField(false,"_mtextfield" /*RemoteObject*/ ).runMethod(false,"getFont");Debug.locals.put("Font1", _font1);Debug.locals.put("Font1", _font1);
 BA.debugLineNum = 144;BA.debugLine="Dim oldfield As B4XView = mTextField";
Debug.JustUpdateDeviceLine();
...
_oldfield = __ref.getField(false,"_mtextfield" /*RemoteObject*/ );Debug.locals.put("oldfield", _oldfield);Debug.locals.put("oldfield", _oldfield);
 BA.debugLineNum = 146;BA.debugLine="CreateTextFieldAll(Not(ToRegular), Font1, textcol";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_createtextfieldall" /*RemoteObject*/ ,(Object)(parent.__c.runMethod(true,"Not",(Object)(_toregular))),(Object)(_font1),(Object)(_textcolor));
 BA.debugLineNum = 147;BA.debugLine="mTextField.Text = text";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mtextfield" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(_text));
 BA.debugLineNum = 148;BA.debugLine="If lblClear.IsInitialized Then";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 149;BA.debugLine="If ToRegular = False Then";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 9;
 BA.debugLineNum = 150;BA.debugLine="lblClear.Text = Chr(0xE8F4)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_lblclear" /*RemoteObject*/ ).runMethod(true,"setText",BA.ObjectToCharSequence(parent.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, ((int)0xe8f4))))));
 BA.debugLineNum = 151;BA.debugLine="lblClear.Tag = \"reveal\"";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_lblclear" /*RemoteObject*/ ).runMethod(false,"setTag",RemoteObject.createImmutable(("reveal")));
 if (true) break;
...
//C
this.state = 9;
 BA.debugLineNum = 153;BA.debugLine="lblClear.Tag = \"hide\"";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_lblclear" /*RemoteObject*/ ).runMethod(false,"setTag",RemoteObject.createImmutable(("hide")));
 BA.debugLineNum = 154;BA.debugLine="lblClear.Text = Chr(0xE8F5)";
Debug.JustUpdateDeviceLine();
...
this.state = 10;
;
 BA.debugLineNum = 156;BA.debugLine="lblClear.BringToFront";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_lblclear" /*RemoteObject*/ ).runVoidMethod ("BringToFront");
 if (true) break;
;
 BA.debugLineNum = 158;BA.debugLine="If lblV.IsInitialized Then lblV.BringToFront";
Debug.JustUpdateDeviceLine();
...
this.state = 16;
;
 BA.debugLineNum = 159;BA.debugLine="HintImageView.BringToFront";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_hintimageview" /*RemoteObject*/ ).runVoidMethod ("BringToFront");
 BA.debugLineNum = 160;BA.debugLine="Base_Resize(mBase.Width, mBase.Height)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_base_resize" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"))));
 BA.debugLineNum = 165;BA.debugLine="Dim et As EditText = mTextField";
Debug.JustUpdateDeviceLine();
_et = RemoteObject.createNew ("anywheresoftware.b4a.objects.EditTextWrapper");
_et = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.EditTextWrapper"), __ref.getField(false,"_mtextfield" /*RemoteObject*/ ).getObject());Debug.locals.put("et", _et);Debug.locals.put("et", _et);
 BA.debugLineNum = 166;BA.debugLine="et.SelectionStart = mTextField.Text.Length";
Debug.JustUpdateDeviceLine();
_et.runMethod(true,"setSelectionStart",__ref.getField(false,"_mtextfield" /*RemoteObject*/ ).runMethod(true,"getText").runMethod(true,"length"));
 BA.debugLineNum = 168;BA.debugLine="LastSwitchTextFieldTime = DateTime.Now";
Debug.JustUpdateDeviceLine();
__ref.setField ("_lastswitchtextfieldtime" /*RemoteObject*/ ,parent.__c.getField(false,"DateTime").runMethod(true,"getNow"));
 BA.debugLineNum = 169;BA.debugLine="mTextField.RequestFocus";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mtextfield" /*RemoteObject*/ ).runVoidMethod ("RequestFocus");
 BA.debugLineNum = 170;BA.debugLine="oldfield.RemoveViewFromParent";
Debug.JustUpdateDeviceLine();
_oldfield.runVoidMethod ("RemoveViewFromParent");
 BA.debugLineNum = 172;BA.debugLine="LastSwitchTextFieldTime = DateTime.Now + 200";
Debug.JustUpdateDeviceLine();
__ref.setField ("_lastswitchtextfieldtime" /*RemoteObject*/ ,RemoteObject.solve(new RemoteObject[] {parent.__c.getField(false,"DateTime").runMethod(true,"getNow"),RemoteObject.createImmutable(200)}, "+",1, 2));
 BA.debugLineNum = 173;BA.debugLine="et.Enabled = False";
Debug.JustUpdateDeviceLine();
_et.runMethod(true,"setEnabled",parent.__c.getField(true,"False"));
 BA.debugLineNum = 174;BA.debugLine="Sleep(50)";
Debug.JustUpdateDeviceLine();
...
this.state = 16;
;
 BA.debugLineNum = 175;BA.debugLine="et.Enabled = True";
Debug.JustUpdateDeviceLine();
_et.runMethod(true,"setEnabled",parent.__c.getField(true,"True"));
 BA.debugLineNum = 176;BA.debugLine="Sleep(50)";
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("Sleep",__ref.getField(false, "ba"),anywheresoftware.b4a.pc.PCResumableSub.createDebugResumeSub(this, "b4xfloattextfield", "switchfrompasswordtoregular"),BA.numberCast(int.class, 50));
this.state = 21;
return;
...
this.state = 16;
;
 BA.debugLineNum = 177;BA.debugLine="et.RequestFocus";
Debug.JustUpdateDeviceLine();
_et.runVoidMethod ("RequestFocus");
 BA.debugLineNum = 178;BA.debugLine="IME.ShowKeyboard(mTextField)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_ime" /*RemoteObject*/ ).runVoidMethod ("ShowKeyboard",(Object)((__ref.getField(false,"_mtextfield" /*RemoteObject*/ ).getObject())));
 BA.debugLineNum = 180;BA.debugLine="If xui.SubExists(mCallBack, mEventName & \"_Passwo";
Debug.JustUpdateDeviceLine();
if (true) break;
...
//C
this.state = 19;
 BA.debugLineNum = 181;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_Passwo";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("tf_Action (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,280);
...
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 281;BA.debugLine="If mNextTextField.IsInitialized And mNextTextFiel";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(".",__ref.getField(false,"_mnexttextfield" /*RemoteObject*/ ).runMethod(true,"IsInitialized" /*RemoteObject*/ )) && RemoteObject.solveBoolean("!",__ref.getField(false,"_mnexttextfield" /*RemoteObject*/ ),(__ref))) { 
 BA.debugLineNum = 282;BA.debugLine="mNextTextField.TextField.RequestFocus";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_mnexttextfield" /*RemoteObject*/ ).runClassMethod (gr.mythologia.b4xfloattextfield.class, "_gettextfield" /*RemoteObject*/ ).runVoidMethod ("RequestFocus");
 };
 BA.debugLineNum = 284;BA.debugLine="If xui.SubExists(mCallBack, mEventName & \"_EnterP";
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"SubExists",__ref.getField(false, "ba"),(Object)(__ref.getField(false,"_mcallback" /*RemoteObject*/ )),(Object)(RemoteObject.concat(__ref.getField(true,"_meventname" /*RemoteObject*/ ),RemoteObject.createImmutable("_EnterPressed"))),(Object)(BA.numberCast(int.class, 0))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 285;BA.debugLine="CallSubDelayed(mCallBack, mEventName & \"_EnterPr";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("tf_BeginEdit (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,272);
...
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 273;BA.debugLine="tf_FocusChanged(True)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_tf_focuschanged" /*RemoteObject*/ ,(Object)(b4xfloattextfield.__c.getField(true,"True")));
...
try {
		Debug.PushSubsStack("tf_EndEdit (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,276);
...
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 277;BA.debugLine="tf_FocusChanged(False)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_tf_focuschanged" /*RemoteObject*/ ,(Object)(b4xfloattextfield.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("tf_EnterPressed (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,323);
...
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 324;BA.debugLine="tf_Action";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_tf_action" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("tf_FocusChanged (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,237);
...
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 238;BA.debugLine="Focused = HasFocus";
Debug.JustUpdateDeviceLine();
__ref.setField ("_focused" /*RemoteObject*/ ,_hasfocus);
 BA.debugLineNum = 239;BA.debugLine="UpdateLabel(mTextField.Text, True)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_updatelabel" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_mtextfield" /*RemoteObject*/ ).runMethod(true,"getText")),(Object)(b4xfloattextfield.__c.getField(true,"True")));
 BA.debugLineNum = 240;BA.debugLine="If xui.SubExists(mCallBack, mEventName & \"_FocusC";
Debug.JustUpdateDeviceLine();
if (__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"SubExists",__ref.getField(false, "ba"),(Object)(__ref.getField(false,"_mcallback" /*RemoteObject*/ )),(Object)(RemoteObject.concat(__ref.getField(true,"_meventname" /*RemoteObject*/ ),RemoteObject.createImmutable("_FocusChanged"))),(Object)(BA.numberCast(int.class, 1))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 241;BA.debugLine="If LastSwitchTextFieldTime + 100 < DateTime.Now";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("<",RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_lastswitchtextfieldtime" /*RemoteObject*/ ),RemoteObject.createImmutable(100)}, "+",1, 2),b4xfloattextfield.__c.getField(false,"DateTime").runMethod(true,"getNow"))) { 
 BA.debugLineNum = 242;BA.debugLine="CallSubDelayed2(mCallBack, mEventName & \"_Focus";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("tf_TextChanged (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,290);
...
Debug.locals.put("New", _new);
 BA.debugLineNum = 290;BA.debugLine="Private Sub tf_TextChanged (Old As String, New As";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 291;BA.debugLine="UpdateLabel(New, False)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_updatelabel" /*RemoteObject*/ ,(Object)(_new),(Object)(b4xfloattextfield.__c.getField(true,"False")));
 BA.debugLineNum = 292;BA.debugLine="If xui.SubExists(mCallBack, mEventName & \"_TextCh";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean(".",__ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(true,"SubExists",__ref.getField(false, "ba"),(Object)(__ref.getField(false,"_mcallback" /*RemoteObject*/ )),(Object)(RemoteObject.concat(__ref.getField(true,"_meventname" /*RemoteObject*/ ),RemoteObject.createImmutable("_TextChanged"))),(Object)(BA.numberCast(int.class, 2)))) && RemoteObject.solveBoolean(".",__ref.getField(false,"_mtextfield" /*RemoteObject*/ ).runMethod(true,"IsInitialized"))) { 
 BA.debugLineNum = 293;BA.debugLine="CallSub3(mCallBack, mEventName & \"_TextChanged\",";
Debug.JustUpdateDeviceLine();
...
try {
		Debug.PushSubsStack("Update (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,248);
...
RemoteObject _r = RemoteObject.declareNull("anywheresoftware.b4a.objects.B4XCanvas.B4XRect");
 BA.debugLineNum = 248;BA.debugLine="Public Sub Update";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 249;BA.debugLine="Dim f As B4XFont =  xui.CreateFont2(HintFont, Lar";
Debug.JustUpdateDeviceLine();
_f = __ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(false,"CreateFont2",(Object)(__ref.getField(false,"_hintfont" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_largelabeltextsize" /*RemoteObject*/ )));Debug.locals.put("f", _f);Debug.locals.put("f", _f);
 BA.debugLineNum = 250;BA.debugLine="Dim r As B4XRect = MeasuringCanvas.MeasureText(Hi";
Debug.JustUpdateDeviceLine();
_r = __ref.getField(false,"_measuringcanvas" /*RemoteObject*/ ).runMethod(false,"MeasureText",(Object)(__ref.getField(true,"_hinttext" /*RemoteObject*/ )),(Object)(_f));Debug.locals.put("r", _r);Debug.locals.put("r", _r);
 BA.debugLineNum = 251;BA.debugLine="LargeFocused = CreateBitmap(r, HintColor, f)";
Debug.JustUpdateDeviceLine();
__ref.setField ("_largefocused" /*RemoteObject*/ ,__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_createbitmap" /*RemoteObject*/ ,(Object)(_r),(Object)(__ref.getField(true,"_hintcolor" /*RemoteObject*/ )),(Object)(_f)));
 BA.debugLineNum = 252;BA.debugLine="LargeNotFocused = CreateBitmap(r, NonFocusedHintC";
Debug.JustUpdateDeviceLine();
__ref.setField ("_largenotfocused" /*RemoteObject*/ ,__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_createbitmap" /*RemoteObject*/ ,(Object)(_r),(Object)(__ref.getField(true,"_nonfocusedhintcolor" /*RemoteObject*/ )),(Object)(_f)));
 BA.debugLineNum = 253;BA.debugLine="f = xui.CreateFont2(HintFont, SmallLabelTextSize)";
Debug.JustUpdateDeviceLine();
_f = __ref.getField(false,"_xui" /*RemoteObject*/ ).runMethod(false,"CreateFont2",(Object)(__ref.getField(false,"_hintfont" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_smalllabeltextsize" /*RemoteObject*/ )));Debug.locals.put("f", _f);
 BA.debugLineNum = 254;BA.debugLine="Dim r As B4XRect = MeasuringCanvas.MeasureText(Hi";
Debug.JustUpdateDeviceLine();
_r = __ref.getField(false,"_measuringcanvas" /*RemoteObject*/ ).runMethod(false,"MeasureText",(Object)(__ref.getField(true,"_hinttext" /*RemoteObject*/ )),(Object)(_f));Debug.locals.put("r", _r);Debug.locals.put("r", _r);
 BA.debugLineNum = 255;BA.debugLine="SmallFocused = CreateBitmap(r, HintColor, f)";
Debug.JustUpdateDeviceLine();
__ref.setField ("_smallfocused" /*RemoteObject*/ ,__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_createbitmap" /*RemoteObject*/ ,(Object)(_r),(Object)(__ref.getField(true,"_hintcolor" /*RemoteObject*/ )),(Object)(_f)));
 BA.debugLineNum = 256;BA.debugLine="SmallNotFocused = CreateBitmap(r, NonFocusedHintC";
Debug.JustUpdateDeviceLine();
__ref.setField ("_smallnotfocused" /*RemoteObject*/ ,__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_createbitmap" /*RemoteObject*/ ,(Object)(_r),(Object)(__ref.getField(true,"_nonfocusedhintcolor" /*RemoteObject*/ )),(Object)(_f)));
 BA.debugLineNum = 257;BA.debugLine="UpdateLabel(mTextField.Text, True)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xfloattextfield.class, "_updatelabel" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_mtextfield" /*RemoteObject*/ ).runMethod(true,"getText")),(Object)(b4xfloattextfield.__c.getField(true,"True")));
...
try {
		Debug.PushSubsStack("UpdateLabel (b4xfloattextfield) ","b4xfloattextfield",9,__ref.getField(false, "ba"),__ref,213);
...
Debug.locals.put("force", _force);
 BA.debugLineNum = 213;BA.debugLine="Private Sub UpdateLabel (txt As String, force As B";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 214;BA.debugLine="For Each lbl As B4XView In Array As B4XView(lblCl";
Debug.JustUpdateDeviceLine();
{
...
Debug.locals.put("lbl", _lbl);
 BA.debugLineNum = 215;BA.debugLine="If lbl.IsInitialized Then lbl.Visible = Focused";
Debug.JustUpdateDeviceLine();
if (_lbl.runMethod(true,"IsInitialized").<Boolean>get().booleanValue()) { 
_lbl.runMethod(true,"setVisible",BA.ObjectToBoolean(RemoteObject.solveBoolean(".",__ref.getField(true,"_focused" /*RemoteObject*/ )) && RemoteObject.solveBoolean(".",BA.ObjectToBoolean((RemoteObject.solveBoolean(".",BA.ObjectToBoolean((RemoteObject.solveBoolean(".",__ref.getField(true,"_showacceptbuttonwhenempty" /*RemoteObject*/ )) && RemoteObject.solveBoolean("=",_lbl,__ref.getField(false,"_lblv" /*RemoteObject*/ ))))) || RemoteObject.solveBoolean(">",_txt.runMethod(true,"length"),BA.numberCast(double.class, 0))))) && RemoteObject.solveBoolean(".",__ref.getField(true,"_menabled" /*RemoteObject*/ ))));};
 }
}Debug.locals.put("lbl", _lbl);
;
 BA.debugLineNum = 218;BA.debugLine="Dim GoingToLarge As Boolean = txt.Length = 0";
Debug.JustUpdateDeviceLine();
_goingtolarge = BA.ObjectToBoolean(RemoteObject.solveBoolean("=",_txt.runMethod(true,"length"),BA.numberCast(double.class, 0)));Debug.locals.put("GoingToLarge", _goingtolarge);Debug.locals.put("GoingToLarge", _goingtolarge);
 BA.debugLineNum = 219;BA.debugLine="If GoingToLarge = LargeLabel And force = False Th";
Debug.JustUpdateDeviceLine();
...
_b = __ref.getField(false,"_smallfocused" /*RemoteObject*/ );Debug.locals.put("b", _b);};
 ...
 BA.debugLineNum = 224;BA.debugLine="If GoingToLarge Then b = LargeNotFocused Else b";
Debug.JustUpdateDeviceLine();
if (_goingtolarge.<Boolean>get().booleanValue()) { 
...
_b = __ref.getField(false,"_smallnotfocused" /*RemoteObject*/ );Debug.locals.put("b", _b);};
 ...
 BA.debugLineNum = 226;BA.debugLine="If b.IsInitialized = False Then Return";
Debug.JustUpdateDeviceLine();
if (RemoteObject.solveBoolean("=",_b.runMethod(true,"IsInitialized"),b4xfloattextfield.__c.getField(true,"False"))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 227;BA.debugLine="HintImageView.SetBitmap(b)";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_hintimageview" /*RemoteObject*/ ).runVoidMethod ("SetBitmap",(Object)((_b.getObject())));
 BA.debugLineNum = 228;BA.debugLine="If GoingToLarge Then";
Debug.JustUpdateDeviceLine();
if (_goingtolarge.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 229;BA.debugLine="HintImageView.SetLayoutAnimated (AnimationDurati";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_hintimageview" /*RemoteObject*/ ).runVoidMethod ("SetLayoutAnimated",(Object)(__ref.getField(true,"_animationduration" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_hintlabellargeoffsetx" /*RemoteObject*/ )),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"),RemoteObject.createImmutable(2),_b.runMethod(true,"getHeight"),RemoteObject.createImmutable(2)}, "/-/",1, 0))),(Object)(BA.numberCast(int.class, _b.runMethod(true,"getWidth"))),(Object)(BA.numberCast(int.class, _b.runMethod(true,"getHeight"))));
 BA.debugLineNum = 230;BA.debugLine="LargeLabel = True";
Debug.JustUpdateDeviceLine();
__ref.setField ("_largelabel" /*RemoteObject*/ ,b4xfloattextfield.__c.getField(true,"True"));
 }else {
 BA.debugLineNum = 232;BA.debugLine="HintImageView.SetLayoutAnimated(AnimationDuratio";
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_hintimageview" /*RemoteObject*/ ).runVoidMethod ("SetLayoutAnimated",(Object)(__ref.getField(true,"_animationduration" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_hintlabelsmalloffsetx" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_hintlabelsmalloffsety" /*RemoteObject*/ )),(Object)(BA.numberCast(int.class, _b.runMethod(true,"getWidth"))),(Object)(BA.numberCast(int.class, _b.runMethod(true,"getHeight"))));
 BA.debugLineNum = 233;BA.debugLine="LargeLabel = False";
Debug.JustUpdateDeviceLine();
