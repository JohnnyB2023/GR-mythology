...
try {
		Debug.PushSubsStack("Alpha_Touch (b4xcolortemplate) ","b4xcolortemplate",5,__ref.getField(false, "ba"),__ref,263);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xcolortemplate.class, "_alphabarselectedchange" /*RemoteObject*/ ,(Object)(_x));
...
try {
		Debug.PushSubsStack("AlphaBarSelectedChange (b4xcolortemplate) ","b4xcolortemplate",5,__ref.getField(false, "ba"),__ref,147);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xcolortemplate.class, "_update" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("Base_Resize (b4xcolortemplate) ","b4xcolortemplate",5,__ref.getField(false, "ba"),__ref,51);
...
RemoteObject _cpp = RemoteObject.declareNull("gr.mythologia.b4xcolortemplate._colorpickerpart");
int _i = 0;
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xcolortemplate.class, "_drawcheckers" /*RemoteObject*/ ,(Object)(_cpp));
 };
 }
}Debug.locals.put("cpp", _cpp);
;
...
b4xcolortemplate._huebar = RemoteObject.createNew ("gr.mythologia.b4xcolortemplate._colorpickerpart");__ref.setField("_huebar",b4xcolortemplate._huebar);
b4xcolortemplate._colorpicker = RemoteObject.createNew ("gr.mythologia.b4xcolortemplate._colorpickerpart");__ref.setField("_colorpicker",b4xcolortemplate._colorpicker);
b4xcolortemplate._alphabar = RemoteObject.createNew ("gr.mythologia.b4xcolortemplate._colorpickerpart");__ref.setField("_alphabar",b4xcolortemplate._alphabar);
...
b4xcolortemplate._xdialog = RemoteObject.createNew ("gr.mythologia.b4xdialog");__ref.setField("_xdialog",b4xcolortemplate._xdialog);
...
try {
		Debug.PushSubsStack("Colors_Touch (b4xcolortemplate) ","b4xcolortemplate",5,__ref.getField(false, "ba"),__ref,253);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xcolortemplate.class, "_handleselectedcolorchanged" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, _x)),(Object)(BA.numberCast(int.class, _y)));
...
try {
		Debug.PushSubsStack("ColorToHSV (b4xcolortemplate) ","b4xcolortemplate",5,__ref.getField(false, "ba"),__ref,199);
...
try {
		Debug.PushSubsStack("CreatePanelForBitmapCreator (b4xcolortemplate) ","b4xcolortemplate",5,__ref.getField(false, "ba"),__ref,30);
...
Debug.JustUpdateDeviceLine();
_cpp = RemoteObject.createNew ("gr.mythologia.b4xcolortemplate._colorpickerpart");Debug.locals.put("cpp", _cpp);
...
try {
		Debug.PushSubsStack("DialogClosed (b4xcolortemplate) ","b4xcolortemplate",5,__ref.getField(false, "ba"),__ref,241);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xcolortemplate.class, "_setselectedhsvcolor" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_initialcolor" /*RemoteObject*/ )));
 };
...
try {
		Debug.PushSubsStack("DrawAlphaBar (b4xcolortemplate) ","b4xcolortemplate",5,__ref.getField(false, "ba"),__ref,109);
...
try {
		Debug.PushSubsStack("DrawCheckers (b4xcolortemplate) ","b4xcolortemplate",5,__ref.getField(false, "ba"),__ref,79);
...
try {
		Debug.PushSubsStack("DrawColors (b4xcolortemplate) ","b4xcolortemplate",5,__ref.getField(false, "ba"),__ref,126);
...
try {
		Debug.PushSubsStack("DrawHueBar (b4xcolortemplate) ","b4xcolortemplate",5,__ref.getField(false, "ba"),__ref,98);
...
try {
		Debug.PushSubsStack("GetPanel (b4xcolortemplate) ","b4xcolortemplate",5,__ref.getField(false, "ba"),__ref,230);
...
try {
		Debug.PushSubsStack("getSelectedColor (b4xcolortemplate) ","b4xcolortemplate",5,__ref.getField(false, "ba"),__ref,175);
...
Debug.JustUpdateDeviceLine();
_hsv = __ref.runClassMethod (gr.mythologia.b4xcolortemplate.class, "_getselectedhsvcolor" /*RemoteObject*/ );Debug.locals.put("hsv", _hsv);Debug.locals.put("hsv", _hsv);
...
try {
		Debug.PushSubsStack("getSelectedHSVColor (b4xcolortemplate) ","b4xcolortemplate",5,__ref.getField(false, "ba"),__ref,186);
...
try {
		Debug.PushSubsStack("HandleSelectedColorChanged (b4xcolortemplate) ","b4xcolortemplate",5,__ref.getField(false, "ba"),__ref,163);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xcolortemplate.class, "_updatebarcolor" /*RemoteObject*/ );
...
try {
		Debug.PushSubsStack("HueBar_Touch (b4xcolortemplate) ","b4xcolortemplate",5,__ref.getField(false, "ba"),__ref,258);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xcolortemplate.class, "_huebarselectedchanged" /*RemoteObject*/ ,(Object)(_y));
...
try {
		Debug.PushSubsStack("HueBarSelectedChanged (b4xcolortemplate) ","b4xcolortemplate",5,__ref.getField(false, "ba"),__ref,136);
...
try {
		Debug.PushSubsStack("Initialize (b4xcolortemplate) ","b4xcolortemplate",5,__ref.getField(false, "ba"),__ref,17);
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_huebar" /*RemoteObject*/ ,__ref.runClassMethod (gr.mythologia.b4xcolortemplate.class, "_createpanelforbitmapcreator" /*RemoteObject*/ ,(Object)(BA.ObjectToString("hueBar")),(Object)(b4xcolortemplate.__c.getField(true,"False"))));
 BA.debugLineNum = 25;BA.debugLine="ColorPicker = CreatePanelForBitmapCreator(\"colors";
Debug.JustUpdateDeviceLine();
__ref.setField ("_colorpicker" /*RemoteObject*/ ,__ref.runClassMethod (gr.mythologia.b4xcolortemplate.class, "_createpanelforbitmapcreator" /*RemoteObject*/ ,(Object)(BA.ObjectToString("colors")),(Object)(b4xcolortemplate.__c.getField(true,"True"))));
 BA.debugLineNum = 26;BA.debugLine="AlphaBar = CreatePanelForBitmapCreator(\"alpha\", T";
Debug.JustUpdateDeviceLine();
__ref.setField ("_alphabar" /*RemoteObject*/ ,__ref.runClassMethod (gr.mythologia.b4xcolortemplate.class, "_createpanelforbitmapcreator" /*RemoteObject*/ ,(Object)(BA.ObjectToString("alpha")),(Object)(b4xcolortemplate.__c.getField(true,"True"))));
 BA.debugLineNum = 27;BA.debugLine="Base_Resize(mBase.Width, mBase.Height)";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xcolortemplate.class, "_base_resize" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(double.class, __ref.getField(false,"_mbase" /*RemoteObject*/ ).runMethod(true,"getHeight"))));
...
try {
		Debug.PushSubsStack("setSelectedColor (b4xcolortemplate) ","b4xcolortemplate",5,__ref.getField(false, "ba"),__ref,181);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xcolortemplate.class, "_setselectedhsvcolor" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (gr.mythologia.b4xcolortemplate.class, "_colortohsv" /*RemoteObject*/ ,(Object)(_i))));
...
try {
		Debug.PushSubsStack("setSelectedHSVColor (b4xcolortemplate) ","b4xcolortemplate",5,__ref.getField(false, "ba"),__ref,190);
...
try {
		Debug.PushSubsStack("Show (b4xcolortemplate) ","b4xcolortemplate",5,__ref.getField(false, "ba"),__ref,234);
...
public ResumableSub_Show(gr.mythologia.b4xcolortemplate parent,RemoteObject __ref,RemoteObject _dialog) {
this.parent = parent;
this.__ref = __ref;
...
Debug.JustUpdateDeviceLine();
__ref.setField ("_initialcolor" /*RemoteObject*/ ,__ref.runClassMethod (gr.mythologia.b4xcolortemplate.class, "_getselectedhsvcolor" /*RemoteObject*/ ));
...
try {
		Debug.PushSubsStack("Update (b4xcolortemplate) ","b4xcolortemplate",5,__ref.getField(false, "ba"),__ref,158);
...
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xcolortemplate.class, "_drawcolors" /*RemoteObject*/ );
 BA.debugLineNum = 160;BA.debugLine="HandleSelectedColorChanged(DONT_CHANGE, DONT_CHAN";
Debug.JustUpdateDeviceLine();
__ref.runClassMethod (gr.mythologia.b4xcolortemplate.class, "_handleselectedcolorchanged" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_dont_change" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_dont_change" /*RemoteObject*/ )));
...
try {
		Debug.PushSubsStack("UpdateBarColor (b4xcolortemplate) ","b4xcolortemplate",5,__ref.getField(false, "ba"),__ref,247);
...
Debug.JustUpdateDeviceLine();
__ref.getField(false,"_xdialog" /*RemoteObject*/ ).getField(false,"_titlebar" /*RemoteObject*/ ).runMethod(true,"setColor",__ref.runClassMethod (gr.mythologia.b4xcolortemplate.class, "_getselectedcolor" /*RemoteObject*/ ));
 };
